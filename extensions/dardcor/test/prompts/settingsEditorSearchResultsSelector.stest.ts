...
ssuite({ title: 'settingsEditorSearchResultsSelector', location: 'external' }, () => {
	...
	stest({ description: 'Selects expected agent mode setting' }, async (testingServiceCollection) => {
		...
		const settingsList: SettingListItem[] = [
			{
				'key': 'github.dardcor.chat.codesearch.enabled',
				'type': 'boolean',
			...
			{
				'key': 'github.dardcor.chat.agent.runTasks',
				'type': 'boolean',
			...
			{
				'key': 'github.dardcor.advanced',
				'type': 'object'
			},
			{
				'key': 'github.dardcor.chat.newWorkspaceCreation.enabled',
				'type': 'boolean',
			...
			{
				'key': 'github.dardcor.chat.completionContext.typescript.mode',
				'type': 'string',
			...
			{
				'key': 'github.dardcor.chat.agent.thinkingTool',
				'type': 'boolean',
