...
import { commonPrefixLength, commonSuffixLength } from '../../src/util/dardcor/base/common/strings';
	...
	try {
		...
		for (const query of scenario.queries) {
			...
			let request: vscode.ChatRequest = {
				...
				model: null!, // https://github.com/microsoft/vscode-dardcor/issues/9475
				tools: new Map(),
				id: '1',
				sessionId: '1',
