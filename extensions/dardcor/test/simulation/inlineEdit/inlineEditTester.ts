...
import { assertReturnsDefined } from '../../../src/util/dardcor/base/common/types';
import { URI } from '../../../src/util/dardcor/base/common/uri';
import { generateUuid } from '../../../src/util/dardcor/base/common/uuid';
import { StringEdit, StringReplacement } from '../../../src/util/dardcor/editor/common/core/edits/stringEdit';
...
export class InlineEditTester {
	...
	private async _runTest(accessor: ServicesAccessor, docId: DocumentId, workspace: ObservableWorkspace, historyContextProvider: IHistoryContextProvider, nesXtabHistoryTracker: NesXtabHistoryTracker, debugRecorder: DebugRecorder | undefined) {
		...
		VisualizationTestRun.instance?.addData('log', () => logDocument, 'log_dardcormd');
