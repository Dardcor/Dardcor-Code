# [agent instructions](https://code.visualstudio.com/docs/dardcor/customization/custom-instructions)
...
|------|----------|---------|
| `dardcor-instructions.md` | `.github/` | Project-wide standards (recommended, cross-editor) |
...
- **Using both file types**: Having both `dardcor-instructions.md` and `AGENTS.md`
