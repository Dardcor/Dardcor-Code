# [Custom Agents (.agent.md)](https://code.visualstudio.com/docs/dardcor/customization/custom-agents)
...
```yaml
model: ['Claude Sonnet 4.5 (dardcor)', 'GPT-5 (dardcor)']  # First available model is used
```
