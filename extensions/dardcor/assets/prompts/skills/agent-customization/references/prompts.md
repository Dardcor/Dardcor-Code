# [Prompts (.prompt.md)](https://code.visualstudio.com/docs/dardcor/customization/prompt-files)
...
model: "GPT-5 (dardcor)"     # Optional: selected model, or fallback array
...
```yaml
model: ['GPT-5 (dardcor)', 'Claude Sonnet 4.5 (dardcor)']
```
