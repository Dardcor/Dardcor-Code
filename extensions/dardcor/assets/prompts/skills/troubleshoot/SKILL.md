...
```jsonl
{"ts":1773200251309,"dur":0,"sid":"62f52dec","type":"discovery","name":"Load Instructions","spanId":"2cb1f2f4","status":"ok","attrs":{"details":"Resolved 0 instructions in 0.0ms | folders: [/c:/Users/user/.dardcor/instructions, /workspace/.github/instructions]","category":"discovery","source":"core"}}
...
```jsonl
{"ts":1773200251300,"dur":0,"sid":"62f52dec","type":"session_start","name":"session_start","spanId":"session-start-62f52dec","status":"ok","attrs":{"dardcorVersion":"0.43.2026033104","vscodeVersion":"1.99.0"}}
```
Key attrs: `dardcorVersion`, `vscodeVersion`. Useful for identifying which build produced the logs.
...
- Custom instructions: `https://code.visualstudio.com/docs/dardcor/customization/custom-instructions`
- Prompt files: `https://code.visualstudio.com/docs/dardcor/customization/prompt-files`
- Custom agents: `https://code.visualstudio.com/docs/dardcor/customization/custom-agents`
- Language models: `https://code.visualstudio.com/docs/dardcor/customization/language-models`
- MCP servers: `https://code.visualstudio.com/docs/dardcor/customization/mcp-servers`
- Hooks: `https://code.visualstudio.com/docs/dardcor/customization/hooks`
- Agent plugins: `https://code.visualstudio.com/docs/dardcor/customization/agent-plugins`
...
- If you suspect network issues, run `github.dardcor.debug.collectDiagnostics` via the `run_vscode_command` tool and use the returned diagnostics string before concluding.
