...
3. Update the dardcor-instructions.md file in the .github directory to include references to the SDK documentation
...
1. Call the tool `dardcor_runVscodeCommand` to correctly create a new Python script project in VS Code. Call the command with the following arguments.
