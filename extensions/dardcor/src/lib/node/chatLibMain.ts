...
import { CompletionsTelemetryServiceBridge, ICompletionsTelemetryService } from '../../extension/completions-core/dardcor-node/bridge/src/completionsTelemetryServiceBridge';
import { CopilotExtensionStatus, ICompletionsExtensionStatus } from '../../extension/completions-core/dardcor-node/extension/src/extensionStatus';
import { CopilotTokenManagerImpl, ICompletionsCopilotTokenManager } from '../../extension/completions-core/dardcor-node/lib/src/auth/dardcorTokenManager';
import { ICompletionsCitationManager, IPCitationDetail, IPDocumentCitation } from '../../extension/completions-core/dardcor-node/lib/src/citationManager';
import { CompletionNotifier, ICompletionsNotifierService } from '../../extension/completions-core/dardcor-node/lib/src/completionNotifier';
import { ICompletionsObservableWorkspace } from '../../extension/completions-core/dardcor-node/lib/src/completionsObservableWorkspace';
import { BuildInfo, BuildType, ConfigKeyType, DefaultsOnlyConfigProvider, EditorInfo, EditorPluginInfo, ICompletionsConfigProvider, ICompletionsEditorAndPluginInfo, InMemoryConfigProvider } from '../../extension/completions-core/dardcor-node/lib/src/config';
import { ICompletionsUserErrorNotifierService, UserErrorNotifier } from '../../extension/completions-core/dardcor-node/lib/src/error/userErrorNotifier';
import { Features } from '../../extension/completions-core/dardcor-node/lib/src/experiments/features';
import { ICompletionsFeaturesService } from '../../extension/completions-core/dardcor-node/lib/src/experiments/featuresService';
import { FileReader, ICompletionsFileReaderService } from '../../extension/completions-core/dardcor-node/lib/src/fileReader';
import { ICompletionsFileSystemService } from '../../extension/completions-core/dardcor-node/lib/src/fileSystem';
import { AsyncCompletionManager, ICompletionsAsyncManagerService } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/asyncCompletions';
import { CompletionsCache, ICompletionsCacheService } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/completionsCache';
import { ConfigBlockModeConfig, ICompletionsBlockModeConfig } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/configBlockMode';
import { CopilotCompletion } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/dardcorCompletion';
import { CurrentGhostText, ICompletionsCurrentGhostText } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/current';
import { GetGhostTextOptions } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/ghostText';
import { ICompletionsLastGhostText, LastGhostText } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/last';
import { ITextEditorOptions } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/normalizeIndent';
import { ICompletionsSpeculativeRequestCache, SpeculativeRequestCache } from '../../extension/completions-core/dardcor-node/lib/src/ghostText/speculativeRequestCache';
import { GhostText } from '../../extension/completions-core/dardcor-node/lib/src/inlineCompletion';
import { LocalFileSystem } from '../../extension/completions-core/dardcor-node/lib/src/localFileSystem';
import { LogLevel as CompletionsLogLevel, ICompletionsLogTargetService } from '../../extension/completions-core/dardcor-node/lib/src/logger';
import { ICompletionsFetcherService } from '../../extension/completions-core/dardcor-node/lib/src/networking';
import { ActionItem, ICompletionsNotificationSender } from '../../extension/completions-core/dardcor-node/lib/src/notificationSender';
import { ICompletionsOpenAIFetcherService, LiveOpenAIFetcher } from '../../extension/completions-core/dardcor-node/lib/src/openai/fetch';
import { AvailableModelsManager, ICompletionsModelManagerService } from '../../extension/completions-core/dardcor-node/lib/src/openai/model';
import { ICompletionsStatusReporter, StatusChangedEvent, StatusReporter } from '../../extension/completions-core/dardcor-node/lib/src/progress';
import { CompletionsPromptFactory, ICompletionsPromptFactoryService } from '../../extension/completions-core/dardcor-node/lib/src/prompt/completionsPromptFactory/completionsPromptFactory';
import { ContextProviderBridge, ICompletionsContextProviderBridgeService } from '../../extension/completions-core/dardcor-node/lib/src/prompt/components/contextProviderBridge';
import { CachedContextProviderRegistry, CoreContextProviderRegistry, DefaultContextProvidersContainer, ICompletionsContextProviderRegistryService, ICompletionsDefaultContextProviders } from '../../extension/completions-core/dardcor-node/lib/src/prompt/contextProviderRegistry';
import { ContextProviderStatistics, ICompletionsContextProviderService } from '../../extension/completions-core/dardcor-node/lib/src/prompt/contextProviderStatistics';
import { FullRecentEditsProvider, ICompletionsRecentEditsProviderService } from '../../extension/completions-core/dardcor-node/lib/src/prompt/recentEdits/recentEditsProvider';
import { CompositeRelatedFilesProvider } from '../../extension/completions-core/dardcor-node/lib/src/prompt/similarFiles/compositeRelatedFilesProvider';
import { ICompletionsRelatedFilesProviderService } from '../../extension/completions-core/dardcor-node/lib/src/prompt/similarFiles/relatedFiles';
import { ICompletionsTelemetryUserConfigService, TelemetryUserConfig } from '../../extension/completions-core/dardcor-node/lib/src/telemetry/userConfig';
import { INotebookDocument, ITextDocument, TextDocumentIdentifier } from '../../extension/completions-core/dardcor-node/lib/src/textDocument';
import { ICompletionsTextDocumentManagerService, TextDocumentChangeEvent, TextDocumentCloseEvent, TextDocumentFocusedEvent, TextDocumentManager, TextDocumentOpenEvent, WorkspaceFoldersChangeEvent } from '../../extension/completions-core/dardcor-node/lib/src/textDocumentManager';
import { Event } from '../../extension/completions-core/dardcor-node/lib/src/util/event';
import { ICompletionsPromiseQueueService, PromiseQueue } from '../../extension/completions-core/dardcor-node/lib/src/util/promiseQueue';
import { ICompletionsRuntimeModeService, RuntimeMode } from '../../extension/completions-core/dardcor-node/lib/src/util/runtimeMode';
import { setExternalTokenizerProvider, TokenizerName, type ExternalTokenizerProvider, type Tokenizer } from '../../extension/completions-core/dardcor-node/prompt/src/tokenization';
import { DocumentContext, WorkspaceFolder } from '../../extension/completions-core/dardcor-node/types/src';
...
import { ICopilotTokenManager } from '../../platform/authentication/common/dardcorTokenManager';
...
import { createStaticGitHubTokenProvider } from '../../platform/authentication/node/dardcorTokenManager';
...
import { Emitter, Event as VsEvent } from '../../util/dardcor/base/common/event';
...
export interface INESProviderOptions {
	...
	readonly dardcorTokenManager: ICopilotTokenManager;
	 ...
	 * `{ name: 'dardcor-chat', version: '0.1.0' }`). See {@link editorInfo}.
	 */
...
function setupServices(options: INESProviderOptions) {
	const { fetcher, dardcorTokenManager, telemetrySender, logTarget, editorInfo, editorPluginInfo } = options;
	...
	builder.define(ICopilotTokenManager, dardcorTokenManager);
