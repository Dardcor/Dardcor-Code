...
import * as gitExt from '../../../platform/git/dardcor/git';
...
import { cancelOnDispose } from '../../../util/dardcor/base/common/cancellation';
...
import { autorun, autorunWithStore, derived, observableFromEvent, observableSignal, waitForState } from '../../../util/dardcor/base/common/observable';
import { basename, join } from '../../../util/dardcor/base/common/path';
import { startsWithIgnoreCase } from '../../../util/dardcor/base/common/strings';
import { editFromTextDocumentContentChangeEvents } from '../../inlineEdits/dardcor-node/parts/common';
...
class InitializedWorkspaceRecorderFeature extends Disposable {
	private readonly _logProvider = new VirtualTextDocumentProvider('dardcorLogProvider');
