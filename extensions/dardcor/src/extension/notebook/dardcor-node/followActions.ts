...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY = 'github.dardcor.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('github.dardcor.chat.notebook.enableFollowCellExecution', () => {
			this.updateFollowContext(true);
		}));

		this._register(vscode.commands.registerCommand('github.dardcor.chat.notebook.disableFollowCellExecution', () => {
