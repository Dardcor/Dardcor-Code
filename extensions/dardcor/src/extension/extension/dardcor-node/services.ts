...
import { createStaticGitHubTokenProvider, getOrCreateTestingCopilotTokenManager } from '../../../platform/authentication/node/dardcorTokenManager';
import { AuthenticationService } from '../../../platform/authentication/dardcor-node/authenticationService';
import { VSCodeCopilotTokenManager } from '../../../platform/authentication/dardcor-node/dardcorTokenManager';
...
import { NativeEnvServiceImpl } from '../../../platform/env/dardcor-node/nativeEnvServiceImpl';
import { IGitCommitMessageService } from '../../../platform/git/common/gitCommitMessageService';
import { IGitDiffService } from '../../../platform/git/common/gitDiffService';
import { IGitService } from '../../../platform/git/common/gitService';
import { GitServiceImpl } from '../../../platform/git/dardcor-node/gitServiceImpl';
...
import { VsCodeIgnoreService } from '../../../platform/ignore/dardcor-node/ignoreService';
import { IImageService } from '../../../platform/image/common/imageService';
import { VSCodeImageServiceImpl } from '../../../platform/image/dardcor-node/imageServiceImpl';
...
import { FetcherService } from '../../../platform/networking/dardcor-node/fetcherServiceImpl';
...
import { VsCodeCodeSearchAuthenticationService } from '../../../platform/remoteCodeSearch/dardcor-node/codeSearchRepoAuth';
...
import { ScopeSelectorImpl } from '../../../platform/scopeSelection/dardcor-node/scopeSelectionImpl';
import { ISearchService } from '../../../platform/search/common/searchService';
import { SearchServiceImpl } from '../../../platform/search/dardcor-node/searchServiceImpl';
...
import { MicrosoftExperimentationService } from '../../../platform/telemetry/dardcor-node/microsoftExperimentationService';
import { TelemetryService } from '../../../platform/telemetry/dardcor-node/telemetryServiceImpl';
...
import { ToolResultContentRenderer } from '../../agentDebug/dardcor-node/toolResultContentRenderer';
import { GitHubOrgChatResourcesService, IGitHubOrgChatResourcesService } from '../../agents/dardcor-node/githubOrgChatResourcesService';
import { ChatDebugFileLoggerService } from '../../chat/dardcor-node/chatDebugFileLoggerService';
import { ChatHookService } from '../../chat/dardcor-node/chatHookService';
import { HooksOutputChannel } from '../../chat/dardcor-node/hooksOutputChannel';
import { SessionTranscriptService } from '../../chat/dardcor-node/sessionTranscriptService';
import { CommandServiceImpl, ICommandService } from '../../commands/node/commandService';
import { ICopilotInlineCompletionItemProviderService } from '../../completions/common/dardcorInlineCompletionItemProviderService';
import { CopilotInlineCompletionItemProviderService } from '../../completions/dardcor-node/dardcorInlineCompletionItemProviderService';
...
import { ChatAgentService } from '../../conversation/dardcor-node/chatParticipants';
import { FeedbackReporter } from '../../conversation/dardcor-node/feedbackReporter';
import { IUserFeedbackService, UserFeedbackService } from '../../conversation/dardcor-node/userActions';
import { ConversationStore, IConversationStore } from '../../conversationStore/node/conversationStore';
import { SimilarFilesContextService } from '../../inlineEdits/dardcor-node/similarFilesContext';
...
import { LanguageContextProviderService } from '../../languageContextProvider/dardcor-node/languageContextProviderService';
...
import { PowerService } from '../../power/dardcor-node/powerService';
...
import { DevContainerConfigurationServiceImpl } from '../../prompt/dardcor-node/devContainerConfigurationServiceImpl';
import { ProductionEndpointProvider } from '../../prompt/dardcor-node/endpointProviderImpl';
import { GitCommitMessageServiceImpl } from '../../prompt/dardcor-node/gitCommitMessageServiceImpl';
import { GitDiffService } from '../../prompt/dardcor-node/gitDiffService';
import { PromptVariablesServiceImpl } from '../../prompt/dardcor-node/promptVariablesService';
import { RequestLogger } from '../../prompt/dardcor-node/requestLoggerImpl';
import { ScenarioAutomationEndpointProviderImpl } from '../../prompt/dardcor-node/scenarioAutomationEndpointProviderImpl';
import { SettingsEditorSearchServiceImpl } from '../../prompt/dardcor-node/settingsEditorSearchServiceImpl';
...
import { ToolsService } from '../../tools/dardcor-node/toolsService';
import { LanguageContextServiceImpl } from '../../typescriptContext/dardcor-node/languageContextService';
import { IWorkspaceListenerService } from '../../workspaceRecorder/common/workspaceListenerService';
import { WorkspacListenerService } from '../../workspaceRecorder/dardcor-node/workspaceListenerService';
...
import { PromptsServiceImpl } from '../../../platform/promptFiles/dardcor-node/promptsServiceImpl';
...
export function registerServices(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext): void {
	...
	const sessionStoreDbPath = extensionContext.globalStorageUri
		...
		: path.join(os.tmpdir(), 'dardcor-session-store.db');
	...
	const otelDbPath = extensionContext.globalStorageUri
		...
		: path.join(os.tmpdir(), 'dardcor-agent-traces.db');
	...
	const otelSettings = workspace.getConfiguration('github.dardcor.chat.otel');
