 ...
 *    - Under `contributes.commands`: Add the VS Code command (e.g., `dardcor.claude.mycommand`)
 ...
 *     readonly commandId = 'dardcor.claude.mycommand'; // For Command Palette
 *
