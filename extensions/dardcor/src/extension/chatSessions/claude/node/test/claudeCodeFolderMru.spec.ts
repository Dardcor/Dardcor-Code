...
describe('ClaudeCodeFolderMruService', () => {
	...
	it('skips sessions with .worktrees/dardcor- cwd', async () => {
		sessionService.sessions = [
			makeSession({ id: 's1', cwd: '/Users/test/repo/.worktrees/dardcor-abc123' }),
		];
	...
	it('filters git repos with .worktrees/dardcor- path', async () => {
		gitService.recentRepos = [
			{ rootUri: URI.file('/Users/test/repo/.worktrees/dardcor-abc123'), lastAccessTime: 100 },
		];
