...
import { CopilotCLIModels, type CopilotCLIModelInfo, type ICopilotCLISDK } from '../dardcorCli';
...
function buildAutoModel(defaultModel?: CopilotCLIModelInfo): LanguageModelChatInformation {
	return {
		id: 'auto',
		name: 'Auto',
		tooltip: 'Auto routes based on your task and real-time system health and model performance. [Learn More](https://docs.github.com/en/dardcor/concepts/models/auto-model-selection)',
