...
import { CopilotCLIModelInfo, ICopilotCLIAgents, ICopilotCLIModels } from '../../../dardcorcli/node/dardcorCli';
...
import { CopilotCLIChatSessionInitializer } from '../dardcorCLIChatSessionInitializer';
...
function makeChatResource(sessionId: string = 'untitled:new-session'): vscode.Uri {
	return URI.from({ scheme: 'dardcorcli', path: `/${sessionId}` }) as unknown as vscode.Uri;
}
