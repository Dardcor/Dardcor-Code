...
import type { SessionEvent, ToolExecutionCompleteEvent, ToolExecutionStartEvent } from '@github/dardcor/sdk';
...
import { constObservable, IObservable } from '../../../../util/dardcor/base/common/observable';
import { isAbsolutePath, isEqual } from '../../../../util/dardcor/base/common/resources';
...
import { extractChatPromptReferences, getFolderAttachmentPath } from './dardcorCLIPrompt';
...
type FetchCopilotCliDocumentationTool = {
	toolName: 'fetch_dardcor_cli_documentation';
	arguments: Record<string, never>;
};
...
function isInstructionAttachmentPath(path: string): boolean {
	...
	return normalizedPath.endsWith('/.github/dardcor-instructions.md')
...
const ToolFriendlyNameAndHandlers: { [K in ToolCall['toolName']]: [title: string, pre: (invocation: ChatToolInvocationPart, toolCall: ToolCallFor<K>, editId?: string, workingDirectory?: URI) => void, post: (invocation: ChatToolInvocationPart, toolCall: ToolCallFor<K>, result: ToolCallResult, workingDirectory?: URI) => void] } = {
	...
	'fetch_dardcor_cli_documentation': [l10n.t('Fetch Documentation'), emptyInvocation, genericToolInvocationCompleted],
...
export class FakeToolsService implements IToolsService {
	...
	readonly dardcorTools = new Map<ToolName, ICopilotTool<unknown>>();
