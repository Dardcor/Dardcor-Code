...
import { AgentTaskCreatePullRequestResponse, AgentTaskGetResponse, AgentTaskSessionEvent, AgentTaskState } from '@vscode/dardcor-api';
 ...
 * by PR number / global id and follow-up is an `@dardcor` comment.
 */
export interface PrCloudAgentBackend extends CloudAgentBackendCommon {
	...
	/**
	 * Post a follow-up `@dardcor` comment to an existing PR-keyed session.
