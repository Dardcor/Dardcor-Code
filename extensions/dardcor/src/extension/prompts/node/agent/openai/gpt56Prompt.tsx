...
import { Gpt55CopilotIdentityRule as Gpt56CopilotIdentityRule } from '../../base/dardcorIdentity';
	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			...
			<Tag name='task_execution'>
				...
				If completing the user's task requires writing or modifying files, your code and final answer should follow these coding guidelines, though user instructions (i.e. dardcor-instructions.md) may override these guidelines:<br />
				<br />
