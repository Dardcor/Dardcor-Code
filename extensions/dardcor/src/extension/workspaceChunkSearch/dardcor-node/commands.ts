...
export const buildRemoteIndexCommandId = 'github.dardcor.buildRemoteWorkspaceIndex';
export const enableExternalIngestCommandId = 'github.dardcor.enableExternalIngest';
export const deleteExternalIngestWorkspaceIndexCommandId = 'github.dardcor.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('github.dardcor.debug.collectWorkspaceIndexDiagnostics', async () => {
