...
import { ChatResponseProgressPart, Range } from '../../../dardcorTypes';
...
/**
 * @remark Does NOT respected dardcor-ignore. Parent element must make sure the URI is not dardcor-ignored.
 */
