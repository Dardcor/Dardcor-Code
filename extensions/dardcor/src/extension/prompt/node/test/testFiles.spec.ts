...
suite.skipIf(process.platform === 'win32')('TestFileFinder', function () {
	...
	test('determine java test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/dardcor/git/commons-io/src/main/java/org/apache/commons/io/EndianUtils.java',
			'/Users/dardcor/git/commons-io/src/test/java/org/apache/commons/io/EndianUtilsTest.java',
			'file:///Users/dardcor/git/commons-io'
		);
	});

	test('determine rb test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/dardcor/git/github/foo/util.rb',
			'/Users/dardcor/git/github/test/foo/util_test.rb',
			'file:///Users/dardcor/git/github'
		);
	});

	test('determine php test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/dardcor/git/github/foo/util.php',
			'/Users/dardcor/git/github/tests/utilTest.php',
			'file:///Users/dardcor/git/github'
		);
	});
	...
	test('determine ps1 test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/dardcor/git/github/foo/util.ps1',
			'/Users/dardcor/git/github/Tests/util.Tests.ps1',
			'file:///Users/dardcor/git/github'
		);
	});
