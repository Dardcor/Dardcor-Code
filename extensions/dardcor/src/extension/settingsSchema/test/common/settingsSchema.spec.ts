...
describe('SettingsSchema', () => {
	...
	test('only deprecates unknown advanced settings', () => {
		const registeredChatSetting = 'github.dardcor.chat.advanced.feature[preview].enabled';
		const registeredSharedSetting = 'github.dardcor.advanced.sharedFeature';
		...
		expect({
			...
			unknownChatSetting: unknownAdvancedSettingRegex.test('github.dardcor.chat.advanced.unknown'),
			unknownSharedSetting: unknownAdvancedSettingRegex.test('github.dardcor.advanced.unknown'),
			emptyRegistryUnknownSetting: new RegExp(emptyRegistryPatternSource).test('github.dardcor.chat.advanced.unknown'),
			emptyAdvancedSuffix: unknownAdvancedSettingRegex.test('github.dardcor.chat.advanced.'),
			unrelatedSetting: unknownAdvancedSettingRegex.test('editor.fontSize'),
			wrongSeparators: unknownAdvancedSettingRegex.test('githubXdardcorXchatXadvancedXunknown'),
