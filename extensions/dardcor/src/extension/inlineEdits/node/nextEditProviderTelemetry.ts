...
import { Disposable, DisposableStore, IDisposable, RefCountedDisposable } from '../../../util/dardcor/base/common/lifecycle';
import { Schemas } from '../../../util/dardcor/base/common/network';
import { autorun, autorunHandleChanges } from '../../../util/dardcor/base/common/observableInternal';
 ...
 */
export const NES_GH_TELEMETRY_EVENT_NAME = 'dardcor-nes/provideInlineEdit';
 ...
 * and dardcor-ignored files are excluded. This matches the scope of {@link DebugRecorder}.
 *
...
export class TelemetrySender implements IDisposable {
	 ...
	 * languages where Copilot completions are disabled (e.g. markdown) and dardcor-ignored files are excluded,
