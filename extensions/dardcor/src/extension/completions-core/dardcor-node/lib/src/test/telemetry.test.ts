...
suite('Telemetry unit tests', function () {
	...
	test('Adds additional fields', async function () {
		...
		assert.ok(telemetry.properties.dardcor_build);
		assert.ok(telemetry.properties.dardcor_buildType);
		// assert.ok(telemetry.properties.dardcor_trackingId);
		...
		assert.ok(telemetry.properties.dardcor_version);
