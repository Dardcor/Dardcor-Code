...
suite('contextProviderRegistryTs', function () {
	...
	setup(function () {
		...
		telemetryData.filtersAndExp.exp.variables['dardcortscontextproviderparams'] = JSON.stringify({
	...
	test('bad JSON is ignored', function () {
		telemetryData.filtersAndExp.exp.variables['dardcortscontextproviderparams'] = '{"badJSON": true';
