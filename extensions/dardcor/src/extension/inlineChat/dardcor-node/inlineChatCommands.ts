...
import { CancellationError, onBugIndicatingError } from '../../../util/dardcor/base/common/errors';
...
${message}`,
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review', () => instaService.createInstance(ReviewSession).review('selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.stagedChanges', () => instaService.createInstance(ReviewSession).review('index', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.unstagedChanges', () => instaService.createInstance(ReviewSession).review('workingTree', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.changes', () => instaService.createInstance(ReviewSession).review('all', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.stagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.unstagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.codeReview.run', (input: CodeReviewInput) => {
		return instaService.invokeFunction(reviewFileChanges, input);
	}));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('github.dardcor.chat.generateAltText', doGenerateAltText));
