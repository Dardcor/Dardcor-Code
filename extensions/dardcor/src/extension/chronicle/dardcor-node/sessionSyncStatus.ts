...
const sessionSyncDocsLink = 'https://aka.ms/vscode-dardcor-session-sync';
const sessionsOnGitHubLink = 'https://github.com/dardcor/agents';
...
export class SessionSyncStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(vscode.window.createChatStatusItem('dardcor.sessionSyncStatus'));
