...
export class NewWorkspaceCreationResult extends PromptElement<NewWorkspaceElementProps> {
	...
	override async render(state: void, sizing: PromptSizing) {
		...
		return <>
			<TextChunk>
				Create or update the dardcor-instructions.md file in the .github directory with the exact content shown below.<br />
				<br />
			</TextChunk>
			<UnsafeCodeBlock code={`
<!-- Use this file to provide workspace-specific custom instructions to Copilot. For more details, visit https://code.visualstudio.com/docs/dardcor/dardcor-customization#_use-a-githubdardcorinstructionsmd-file -->
- [ ] Verify that the dardcor-instructions.md file in the .github directory is created.
...
- [ ] Ensure Documentation is Complete
	<!--
	Verify that all previous steps have been completed.
	Verify that README.md and the dardcor-instructions.md file in the .github directory exists and contains current project information.
	Clean up the dardcor-instructions.md file in the .github directory by removing all HTML comments.
	 -->
...
- Your task is complete when:
  ...
  - dardcor-instructions.md file in the .github directory exists in the project
...
`} languageId='markdown'></UnsafeCodeBlock>
			<TextChunk>
				<br />
				Verify that a dardcor-instructions.md file in the .github directory exists and systematically work through each item in the task list.<br />
				Update the dardcor-instructions.md file in the .github directory directly as you complete each step.<br />
				<br />
