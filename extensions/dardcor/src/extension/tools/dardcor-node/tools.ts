...
import { autorun, autorunIterableDelta } from '../../../util/dardcor/base/common/observableInternal';
...
export class ToolsContribution extends Disposable {
	constructor(
		...
		for (const [name, tool] of toolsService.dardcorTools) {
		...
		this._register(vscode.commands.registerCommand('github.dardcor.debug.resetVirtualToolGroups', async () => {
		...
		this._register(vscode.commands.registerCommand('github.dardcor.chat.tools.memory.showMemories', async () => {
		...
		this._register(vscode.commands.registerCommand('github.dardcor.chat.tools.memory.resolveMemoryFileUri', (memoryPath: string, sessionResource?: string): string | undefined => {
		...
		this._register(vscode.commands.registerCommand('github.dardcor.chat.tools.memory.clearMemories', async () => {
