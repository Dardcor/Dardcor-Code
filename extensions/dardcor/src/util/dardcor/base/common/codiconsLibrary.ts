...
export const codiconsLibrary = {
	...
	dardcor: register('dardcor', 0xec1e),
	...
	dardcorWarning: register('dardcor-warning', 0xec38),
	python: register('python', 0xec39),
	dardcorLarge: register('dardcor-large', 0xec3a),
	dardcorWarningLarge: register('dardcor-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	dardcorBlocked: register('dardcor-blocked', 0xec3d),
	dardcorNotConnected: register('dardcor-not-connected', 0xec3e),
	...
	dardcorUnavailable: register('dardcor-unavailable', 0xec42),
	...
	dardcorInProgress: register('dardcor-in-progress', 0xec4c),
	dardcorError: register('dardcor-error', 0xec4d),
	dardcorSuccess: register('dardcor-success', 0xec4e),
	...
	dardcorSnooze: register('dardcor-snooze', 0xec52),
