...
import { Disposable, dispose, IDisposable } from '../../../util/dardcor/base/common/lifecycle';
import { ResourceMap } from '../../../util/dardcor/base/common/map';
import { Schemas } from '../../../util/dardcor/base/common/network';
import { basename, extname, isEqual, isEqualOrParent } from '../../../util/dardcor/base/common/resources';
import { TernarySearchTree } from '../../../util/dardcor/base/common/ternarySearchTree';
 ...
 *
 * Caller should also look at file content to make sure the file is not binary or dardcor ignored.
 */
