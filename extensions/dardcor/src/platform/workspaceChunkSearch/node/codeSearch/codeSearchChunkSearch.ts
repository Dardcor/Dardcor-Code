...
import { isEqual, isEqualOrParent } from '../../../../util/dardcor/base/common/resources';
import { StopWatch } from '../../../../util/dardcor/base/common/stopwatch';
import { URI } from '../../../../util/dardcor/base/common/uri';
import { IInstantiationService } from '../../../../util/dardcor/platform/instantiation/common/instantiation';
import { ChatResponseWarningPart } from '../../../../dardcorTypes';
...
export class CodeSearchChunkSearch extends Disposable {
	...
	public canExternalIngestBeEnabled(): boolean {
		return !!this._authenticationService.dardcorToken?.isBlackbirdExternalIndexingEnabled();
	}
