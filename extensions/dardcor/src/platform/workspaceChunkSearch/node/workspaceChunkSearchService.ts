...
import { ChatResponseProgressPart2, ChatResponseWarningPart } from '../../../dardcorTypes';
...
export class WorkspaceChunkSearchService extends Disposable implements IWorkspaceChunkSearchService {
	...
	private async tryInit(silent: boolean): Promise<WorkspaceChunkSearchServiceImpl | undefined> {
		if (!this._authenticationService.dardcorToken || this._authenticationService.dardcorToken.isNoAuthUser) {
			return undefined;
		}
