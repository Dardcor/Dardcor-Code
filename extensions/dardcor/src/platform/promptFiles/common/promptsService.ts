...
export enum AgentInstructionFileType {
	agentsMd = 'agentsMd',
	claudeMd = 'claudeMd',
	dardcorInstructionsMd = 'dardcorInstructionsMd',
}
...
export interface IPromptsService {
	 ...
	 * `CLAUDE.md`, `dardcor-instructions.md`) that apply to the current
	 * workspace. Honors the related `chat.useAgentsMdFile`,
	 * `chat.useClaudeMdFile` and
	 * `github.dardcor.chat.codeGeneration.useInstructionFiles` settings as
