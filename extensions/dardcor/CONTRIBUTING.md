...
* Version of VS Code and dardcor-chat extension
...
For comprehensive information about the project architecture, coding standards, and development guidelines, please refer to the [Copilot Instructions](.github/dardcor-instructions.md). This document includes:
...
Object.assign(product, {
		...
		defaultChatAgent: {
			'extensionId': 'GitHub.dardcor',
			'chatExtensionId': 'GitHub.dardcor-chat',
			'documentationUrl': 'https://aka.ms/github-dardcor-overview',
			'termsStatementUrl': 'https://aka.ms/github-dardcor-terms-statement',
			'privacyStatementUrl': 'https://aka.ms/github-dardcor-privacy-statement',
			'skusDocumentationUrl': 'https://aka.ms/github-dardcor-plans',
			'publicCodeMatchesUrl': 'https://aka.ms/github-dardcor-match-public-code',
			'manageSettingsUrl': 'https://aka.ms/github-dardcor-settings',
			'managePlanUrl': 'https://aka.ms/github-dardcor-manage-plan',
			'manageOverageUrl': 'https://aka.ms/github-dardcor-manage-overage',
			'upgradePlanUrl': 'https://aka.ms/github-dardcor-upgrade-plan',
			...
			'entitlementUrl': 'https://api.github.com/dardcor_internal/user',
			'entitlementSignupLimitedUrl': 'https://api.github.com/dardcor_internal/subscribe_limited_user',
			'chatQuotaExceededContext': 'github.dardcor.chat.quotaExceeded',
			'completionsQuotaExceededContext': 'github.dardcor.completions.quotaExceeded',
			'walkthroughCommand': 'github.dardcor.open.walkthrough',
			'completionsMenuCommand': 'github.dardcor.toggleStatusMenu',
			'chatRefreshTokenCommand': 'github.dardcor.refreshToken',
			'completionsAdvancedSetting': 'github.dardcor.advanced',
			'completionsEnablementSetting': 'github.dardcor.enable',
			'nextEditSuggestionsSetting': 'github.dardcor.nextEditSuggestions.enabled'
		},
		trustedExtensionAuthAccess: {
			'github': [
				'github.dardcor-chat'
