...
The constant `ToolFriendlyNameAndHandlers` in src/extension/chatSessions/dardcorcli/common/dardcorCLITools.ts
...
All of this information has been derived from <dardcor-agent-runtime repo>/src/tools/**
