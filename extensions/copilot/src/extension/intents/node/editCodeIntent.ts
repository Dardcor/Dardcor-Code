...
import { basename, isEqual } from '../../../util/dardcor/base/common/resources';
import { assertType, isObject } from '../../../util/dardcor/base/common/types';
import { isUriComponents, URI } from '../../../util/dardcor/base/common/uri';
import { generateUuid } from '../../../util/dardcor/base/common/uuid';
import { BrandedService, IInstantiationService } from '../../../util/dardcor/platform/instantiation/common/instantiation';
import { ChatRequestEditorData, Location, MarkdownString } from '../../../dardcorTypes';
