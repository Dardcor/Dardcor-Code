...
import { CopilotCLIContrib, getServices } from '../copilotcli/dardcor-node/contribution';
import { CopilotCLIFolderMruService } from '../copilotcli/dardcor-node/copilotCLIFolderMru';
import { ICopilotCLISessionTracker } from '../copilotcli/dardcor-node/copilotCLISessionTracker';
import { CustomSessionTitleService } from '../copilotcli/dardcor-node/customSessionTitleServiceImpl';
import { GHPR_EXTENSION_ID } from '../dardcor/chatSessionsUriHandler';
import { AgentSessionsWorkspace } from './agentSessionsWorkspace';
import { UserQuestionHandler } from '../copilotcli/dardcor-node/askUserQuestionHandler';
import { ChatSessionMetadataStore } from '../copilotcli/dardcor-node/chatSessionMetadataStoreImpl';
...
import { CopilotCLIChatSessionInitializer, ICopilotCLIChatSessionInitializer } from '../copilotcli/dardcor-node/copilotCLIChatSessionInitializer';
...
import { CopilotCLICustomizationProvider } from '../copilotcli/dardcor-node/copilotCLICustomizationProvider';
