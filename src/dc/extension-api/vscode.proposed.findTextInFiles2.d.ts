...
declare module 'vscode' {
	...
	export interface FindTextInFilesOptions2 {
		 ...
		 *
		 * ```ts
		 * const ab = findTextInFiles2('foo', {include: ['*.ts', '*']});
		 * const a = findTextInFiles2('foo', {include: ['*.ts']});
		 * const b = findTextInFiles2('foo', {include: ['*']});
		 * ```
		 *
		 ...
		 *
		 * ```ts
		 * const ab = findTextInFiles2('foo', {exclude: ['*.ts', '*']});
		 * const a = findTextInFiles2('foo', {exclude: ['*.ts']});
		 * const b = findTextInFiles2('foo', {exclude: ['*']});
		 * ```
		 *
