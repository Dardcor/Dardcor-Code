...
declare module 'vscode' {
	...
	export class MarkdownString {
		 ...
		 * // Here 'link' in the rendered markdown resolves to '/path/to/dir/file'
		 * ```
		 *
		 ...
		 * ```ts
		 * const md = new vscode.MarkdownString(`[link](./file.js)`);
		 * md.baseUri = vscode.Uri.file('/path/to/otherFile');
		 * // Here 'link' in the rendered markdown resolves to '/path/to/file'
		 * ```
		 */
		baseUri?: Uri;
	...
	export namespace workspace {
		 ...
		 *
		 * ```ts
		 * vscode.workspace.createFileSystemWatcher(new vscode.RelativePattern(vscode.workspace.workspaceFolders[0], '**​/*'));
		 * ```
		 *
		 ...
		 *
		 * ```ts
		 * vscode.workspace.createFileSystemWatcher(new vscode.RelativePattern(vscode.Uri.file(<path to folder outside workspace>), '*'));
		 * ```
		 *
