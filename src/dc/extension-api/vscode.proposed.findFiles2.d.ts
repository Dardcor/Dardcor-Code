...
declare module 'vscode' {
	...
	export interface FindFiles2Options {
		 ...
		 *
		 * ```ts
		 * const ab = findFiles(['**​/*'], {exclude: ['*.ts', '*']});
		 * const a = findFiles(['**​/*'], {exclude: ['*.ts']});
		 * const b = findFiles(['**​/*'], {exclude: ['*']});
		 * ```
		 *
	...
	export namespace workspace {
		 ...
		 *
		 * @example
		 * findFiles(['**​/*'], {exclude: ['**​/out/**'], useIgnoreFiles: true, maxResults: 10})
		 *
