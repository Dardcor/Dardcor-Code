...
export const codiconsLibrary = {
	...
	copilot: register('copilot', 0xec20),
	dardcorCode: register('dardcor-code', 0xec20),
	...
	copilotLarge: register('copilot-large', 0xec20),
	...
	copilotCompact: register('copilot-compact', 0xec20),
