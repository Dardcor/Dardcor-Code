			...
			suite('zsh', async () => {
				suite('should override args', async () => {
					...
					const expectedSources = [
						/.+\/out\/dc\/workbench\/contrib\/terminal\/common\/scripts\/shellIntegration-rc.zsh/,
						/.+\/out\/dc\/workbench\/contrib\/terminal\/common\/scripts\/shellIntegration-profile.zsh/,
						/.+\/out\/dc\/workbench\/contrib\/terminal\/common\/scripts\/shellIntegration-env.zsh/,
						/.+\/out\/dc\/workbench\/contrib\/terminal\/common\/scripts\/shellIntegration-login.zsh/
					];
