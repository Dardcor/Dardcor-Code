...
|---|---|---|
| Process | Separate utility process (`src/dc/platform/agentHost/node/`) | Extension host |
...
```
                 ┌─────────────────────────────────────────────────────────────────┐
                 │  Agent Host process (src/dc/platform/agentHost)                  │
                 │                                                                 │
