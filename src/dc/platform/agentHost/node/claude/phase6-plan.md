...
- [ ] `npm run eslint -- src/dc/platform/agentHost/node/claude src/dc/platform/agentHost/test/node/claudeAgent.test.ts src/dc/platform/agentHost/test/node/claudeAgent.integration.test.ts` exits 0.
