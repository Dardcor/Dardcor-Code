...
suite('CopilotAgent', () => {
	...
	suite('customization anchoring', () => {
		...
		test('rebaseUnder rebases paths under the source dir and leaves others untouched', () => {
			const original = URI.file('/Users/me/src/dccode');
			const worktree = URI.file('/Users/me/src/dccode.worktrees/agents-x');
			assert.strictEqual(
				rebaseUnder(URI.file('/Users/me/src/dccode/.github/skills/sessions'), original, worktree)?.toString(),
				URI.file('/Users/me/src/dccode.worktrees/agents-x/.github/skills/sessions').toString(),
