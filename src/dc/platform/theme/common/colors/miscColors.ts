...
export const badgeBackground = registerColor('badge.background',
	{ dark: '#3B0A5E', light: '#4A148C', hcDark: Color.black, hcLight: '#0F4A85' },
...
export const scrollbarSliderBackground = registerColor('scrollbarSlider.background',
	{ dark: Color.fromHex('#3B0A5E').transparent(0.5), light: Color.fromHex('#646464').transparent(0.4), hcDark: transparent(contrastBorder, 0.6), hcLight: transparent(contrastBorder, 0.4) },
...
export const scrollbarSliderHoverBackground = registerColor('scrollbarSlider.hoverBackground',
	{ dark: Color.fromHex('#4A148C').transparent(0.8), light: Color.fromHex('#646464').transparent(0.7), hcDark: transparent(contrastBorder, 0.8), hcLight: transparent(contrastBorder, 0.8) },
...
export const scrollbarSliderActiveBackground = registerColor('scrollbarSlider.activeBackground',
	{ dark: Color.fromHex('#6A1B9A').transparent(0.8), light: Color.fromHex('#000000').transparent(0.6), hcDark: transparent(contrastBorder, 1), hcLight: transparent(contrastBorder, 1) },
