...
export function pullRequestOptionsForFragment(fragment: PullRequestFragment, interest: EffectivePullRequestFragmentInterest): PullRequestSubscriptionOptions {
    switch (fragment) {
...
function merge(result: Map<PullRequestFragment, EffectivePullRequestFragmentInterest>, fragment: PullRequestFragment, incoming: EffectivePullRequestFragmentInterest): void {
