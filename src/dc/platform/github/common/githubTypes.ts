...
export type GitHubRequestPriority = 'mutationReconciliation' | 'mutation' | 'interactive' | 'mergeGate' | 'visible' | 'background' | 'enrichment';
export type GitHubRequestErrorKind = 'authentication' | 'authorization' | 'notFound' | 'validation' | 'schema' | 'rateLimit' | 'network' | 'server' | 'malformedResponse' | 'unknown';
