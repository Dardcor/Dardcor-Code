...
export class GitHubCredentialService extends Disposable implements IGitHubCredentials {
    ...
    constructor(scheduler: IGitHubScheduler | undefined, policy: GitHubBackoffPolicy = defaultBackoffPolicy, private readonly _transport: IGitHubTransport, private readonly _tokenProvider: IGitHubTokenProvider, private readonly _endpointProvider: IGitHubEndpointProvider, private readonly _logService?: ILogService) {
        super();
