...
export class GitHubService extends Disposable implements IGitHubService {
    ...
    private readonly _logService: ILogService) {
        ...
        this.pullRequests = this._register(new PullRequestResourceService(undefined, undefined, this.credentials, pullRequestQuery, this._logService));
        this.mutations = this._register(new PullRequestMutationService(undefined, this.credentials, this.transport, this.pullRequests, options.endpoint, this._logService));
        this.query = this._register(new GitHubQueryService(undefined, undefined, this.credentials, this.transport, options.endpoint, this.capabilities, this._logService));
