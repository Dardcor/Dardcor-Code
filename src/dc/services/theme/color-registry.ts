...
function registerDefaultColors(): void {
	...
	const colors: Array<[string, IColorDefaults]> = [
		...
		[ColorTokens.titleBarActiveBackground, { light: '#dddddd', dark: '#3c3c3c' }],
		[ColorTokens.titleBarActiveForeground, { light: '#333333', dark: '#cccccc' }],
		[ColorTokens.panelBackground, { light: '#ffffff', dark: '#1e1e1e' }],
		[ColorTokens.panelBorder, { light: '#e7e7e7', dark: '#80808059' }],
		[ColorTokens.scrollbarSliderBackground, { light: '#64646466', dark: '#79797966' }],
		[ColorTokens.terminalBackground, { light: '#ffffff', dark: '#1e1e1e' }],
		[ColorTokens.terminalForeground, { light: '#333333', dark: '#cccccc' }],
		[ColorTokens.minimapBackground, { light: '#ffffff', dark: '#1e1e1e' }],
