...
/** Opens or focuses a regular editor window. Registered in `dardcorActions.ts`. */
export const OPEN_VSCODE_WINDOW_COMMAND_ID = 'agents.openVSCodeWindow';

/** Returns from the Agents window to a regular editor window. Registered in `dardcorActions.ts`. */
export const RETURN_TO_VSCODE_EDITOR_COMMAND_ID = 'agents.returnToVSCodeEditor';

/** Checks whether the Agents window is the only open main window. Registered in `dardcorActions.ts`. */
