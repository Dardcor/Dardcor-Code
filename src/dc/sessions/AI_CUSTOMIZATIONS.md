...
- `dc/workbench/contrib/chat/browser/aiCustomization/`;
- `dc/workbench/contrib/chat/common/`.

The Agents Window contributes:

- the customizations tree and overview under `dc/sessions/contrib/aiCustomizationTreeView/`;
- Sessions-specific workspace and harness adapters under `dc/sessions/contrib/chat/`;
- Sessions sidebar entry points under `dc/sessions/contrib/sessions/`.

Shared workbench code owns reusable discovery and management behavior. Sessions code adapts active-session context and provider-backed harnesses without adding Sessions dependencies to `dc/workbench`.
