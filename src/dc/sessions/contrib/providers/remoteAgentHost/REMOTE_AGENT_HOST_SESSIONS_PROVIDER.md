...
**File:** `src/dc/sessions/contrib/remoteAgentHost/browser/remoteAgentHostSessionsProvider.ts`
...
```
src/dc/sessions/contrib/remoteAgentHost/browser/remoteAgentHost.contribution.ts
```
