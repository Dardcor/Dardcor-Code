...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	properties: {
		...
		[CloudSandboxEnabledSettingId]: {
			type: 'boolean',
			description: nls.localize('chat.agentHost.cloudSandbox.enabled', "Enable connecting to Dardcor AI cloud sandbox sessions over a live Agent Host Protocol relay. When enabled, opening a Dardcor AI CLI cloud session connects to its sandbox for slash commands and a responsive, steerable experience instead of only polling logs."),
			default: false,
			scope: ConfigurationScope.APPLICATION,
			tags: ['experimental', 'advanced'],
		},
