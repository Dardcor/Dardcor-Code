...
**File:** `src/dc/sessions/contrib/copilotChatSessions/browser/copilotChatSessionsProvider.ts`
...
```
src/dc/sessions/contrib/copilotChatSessions/browser/copilotChatSessions.contribution.ts
```
...
**File:** `src/dc/sessions/contrib/copilotChatSessions/browser/copilotChatSessionsActions.ts`
