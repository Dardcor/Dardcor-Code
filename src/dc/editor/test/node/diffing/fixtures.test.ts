...
suite('diffing fixtures', () => {
	...
	const fixturesOutDir = FileAccess.asFileUri('dc/editor/test/node/diffing/fixtures').fsPath;
	...
	const fixturesSrcDir = resolve(fixturesOutDir).replaceAll('\\', '/').replace('/out/dc/editor/', '/src/dc/editor/');
