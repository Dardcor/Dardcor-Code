...
registerColor('editor.foldPlaceholderForeground', { light: '#6A1B9A', dark: '#6A1B9A', hcDark: null, hcLight: null }, localize('collapsedTextColor', "Color of the collapsed text after the first line of a folded range."));
