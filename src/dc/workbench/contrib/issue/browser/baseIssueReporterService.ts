...
export class BaseIssueReporterService extends Disposable {
	...
	public setSourceOptions(): void {
		...
		sourceSelect.append(this.makeOption(IssueSource.VSCode, this.product.nameLong || localize('vscode', "Dardcor Code"), false));
		sourceSelect.append(this.makeOption(IssueSource.Extension, localize('extension', "A Dardcor Code extension"), false));
