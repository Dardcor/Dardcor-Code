...
export class WorkspaceTagsService implements IWorkspaceTagsService {
	...
	/* __GDPR__FRAGMENT__
		"WorkspaceTags" : {
			...
			"workspace.go.mod.github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/adc/armavs" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
