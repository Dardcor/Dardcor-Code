...
export class TerminalProfileConfigurationTelemetry extends Disposable {
    ...
    private _reportSettingState(telemetryService: ITelemetryService, setting: TerminalProfileSetting): void {
        ...
        type TerminalProfileSettingStateClassification = {
            ...
            settingId: {
                ...
                comment: 'The terminal profile setting that has a configured value.';
            };
            profileType: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'Whether the configured setting controls chat, automation, or default terminals.';
            };
            os: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'The operating system targeted by the configured setting.';
            };
            configured: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'Whether the setting has a configured value.';
            };
        };
    ...
    private _reportSettingChanged(configurationService: IConfigurationService, telemetryService: ITelemetryService, setting: TerminalProfileSetting, source: string): void {
        ...
        type TerminalProfileSettingChangedClassification = {
            ...
            settingId: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'The terminal profile setting that changed.';
            };
            profileType: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'Whether the changed setting controls chat, automation, or default terminals.';
            };
            os: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'The operating system targeted by the changed setting.';
            };
            configured: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'Whether the setting resolves to a configured profile after the change.';
            };
            changeType: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'Whether the effective profile setting was added, changed, or removed.';
            };
            source: {
                classification: 'SystemMetaData';
                purpose: 'FeatureInsight';
                comment: 'The broad configuration change source reported by the configuration service.';
            };
        };
        const configured = this._isConfigured(configurationService, setting.settingId);
