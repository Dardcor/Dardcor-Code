...
export class NotebookMultiTextDiffEditor extends EditorPane {
    ...
    protected createEditor(parent: HTMLElement): void {
        this._multiDiffEditorWidget = this._register(this.instantiationService.createInstance(MultiDiffEditorWidget, parent, this.instantiationService.createInstance(WorkbenchUIElementFactory), { variant: MultiDiffEditorVariant.Standard }));
