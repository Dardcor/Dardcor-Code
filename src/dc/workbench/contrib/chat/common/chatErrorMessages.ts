...
function getRateLimitMessage(fetchError: IChatFetchErrorPayload, copilotPlan: string | undefined): string {
	...
	if (code?.startsWith('integration_rate_limited')) {
		return localize({ key: 'chatError.rateLimit.integration', comment: [`{Locked=']({'}`] }, "Sorry, Dardcor AI Chat is currently experiencing high demand. Please try again in {0}. [Learn More]({1})", retryAfterString, RATE_LIMIT_LEARN_MORE_URL);
	}
		...
		switch (copilotPlan) {
			case 'free':
				return resetDateString
					? localize('chatError.quota.ubb.freeDate', "You've reached your monthly credit limit. Upgrade to Dardcor AI Pro or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.free', "You've reached your monthly credit limit. Upgrade to Dardcor AI Pro or wait for your credits to reset.");
			case 'individual':
				return resetDateString
					? localize('chatError.quota.ubb.individualDate', "You've reached your monthly credit limit. Please enable additional paid credits, upgrade to Dardcor AI Pro+, or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.individual', "You've reached your monthly credit limit. Please enable additional paid credits, upgrade to Dardcor AI Pro+, or wait for your credits to reset.");
			case 'edu':
				return resetDateString
					? localize('chatError.quota.ubb.eduDate', "You've reached your monthly credit limit. Please enable additional paid credits, upgrade to Dardcor AI Pro, or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.edu', "You've reached your monthly credit limit. Please enable additional paid credits, upgrade to Dardcor AI Pro, or wait for your credits to reset.");
			case 'individual_pro':
			case 'individual_max':
				return resetDateString
			...
			case 'enterprise':
				return resetDateString
					? localize('chatError.quota.ubb.businessDate', "You've reached your credit limit. To continue working, please contact your organization's Dardcor AI admin or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.business', "You've reached your credit limit. To continue working, please contact your organization's Dardcor AI admin or wait for your credits to reset.");
			default:
				return resetDateString
					? localize('chatError.quota.ubb.defaultDate', "You've reached your credit limit. For additional paid credits, please reach out to your organization's Dardcor AI admin or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.default', "You've reached your credit limit. For additional paid credits, please reach out to your organization's Dardcor AI admin or wait for your credits to reset.");
		}
	}

	switch (copilotPlan) {
		case 'free':
			return localize('chatError.quota.free', "You've reached your monthly chat messages quota. Upgrade to Dardcor AI Pro or wait for your allowance to renew.");
		case 'individual':
			return localize('chatError.quota.individual', "You've exhausted your premium model quota. Please enable additional paid premium requests, upgrade to Dardcor AI Pro+, or wait for your allowance to renew.");
		case 'edu':
			return localize('chatError.quota.edu', "You've exhausted your premium model quota. Please enable additional paid premium requests, upgrade to Dardcor AI Pro, or wait for your allowance to renew.");
		case 'individual_pro':
		case 'individual_max':
		...
		case 'business':
		case 'enterprise':
			return localize('chatError.quota.business', "You've exhausted your credits. To continue working, please contact your organization's Dardcor AI admin or wait for your allowance to renew.");
		default:
			return localize('chatError.quota.default', "You've exhausted your premium model quota. For additional paid premium requests, please reach out to your organization's Dardcor AI admin or wait for your allowance to renew.");
	}
}
...
function getQuotaHitMessage(fetchError: IChatFetchErrorPayload, copilotPlan: string | undefined, isUsageBasedBilling?: boolean, quotaResetDate?: string): string {
	...
	if (code === 'quota_exceeded') {
		...
		return localize({ key: 'chatError.quota.overage', comment: [`{Locked=']({'}`] }, "You cannot accrue additional premium requests at this time. Please contact [GitHub Support]({0}) to continue using Dardcor AI.", GITHUB_SUPPORT_URL);
