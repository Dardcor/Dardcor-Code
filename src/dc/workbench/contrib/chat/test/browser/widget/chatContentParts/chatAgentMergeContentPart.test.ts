...
suite('ChatAgentMergeContentPart file labels', () => {
	...
	test('names a unique file without a disambiguating path', () => {
		const labels = describeAgentMergeFileLabels([
			{ path: 'src/dc/workbench/contrib/chat/browser/chatWidget.ts', line: 68 },
			{ path: 'src/dc/workbench/contrib/chat/browser/chatEditor.ts' },
			{},
		]);

		assert.deepStrictEqual(labels, [
			{ name: 'chatWidget.ts:68', title: 'src/dc/workbench/contrib/chat/browser/chatWidget.ts' },
			{ name: 'chatEditor.ts', title: 'src/dc/workbench/contrib/chat/browser/chatEditor.ts' },
			undefined,
		]);
	});
	...
	test('adds the shortest distinguishing prefix to same-named files', () => {
		const labels = describeAgentMergeFileLabels([
			{ path: 'src/dc/workbench/contrib/chat/browser/chatWidget.ts', line: 412 },
			{ path: 'src/dc/sessions/contrib/chat/browser/chatWidget.ts', line: 88 },
			{ path: 'src/dc/workbench/contrib/chat/browser/chatEditor.ts', line: 24 },
		]);

		assert.deepStrictEqual(labels, [
			{ name: 'chatWidget.ts:412', description: '…/workbench/…', title: 'src/dc/workbench/contrib/chat/browser/chatWidget.ts' },
			{ name: 'chatWidget.ts:88', description: '…/sessions/…', title: 'src/dc/sessions/contrib/chat/browser/chatWidget.ts' },
			{ name: 'chatEditor.ts:24', title: 'src/dc/workbench/contrib/chat/browser/chatEditor.ts' },
		]);
	});
