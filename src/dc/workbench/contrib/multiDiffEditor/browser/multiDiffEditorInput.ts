...
export class MultiDiffEditorInput extends EditorInput implements ILanguageSupport {
    ...
    private readonly _textFileService: ITextFileService) {
        ...
        this.textFileServiceOnDidChange = new FastEventDispatcher<ITextFileEditorModel, URI>(this._textFileService.files.onDidChangeDirty, item => item.resource.toString(), uri => uri.toString());
