	...
	private layoutTree(): void {
		...
		if (this.showAtPosition) {
			...
			if (containerTop < hoveredCharTop) {
				maxHeightToAvoidCursorOverlay = hoveredCharTop + editorTop - 22; // 22 is monaco top padding https://github.com/microsoft/vscode/blob/a1df2d7319382d42f66ad7f411af01e4cc49c80a/src/dc/editor/browser/viewParts/contentWidgets/contentWidgets.ts#L364
			}
		}
