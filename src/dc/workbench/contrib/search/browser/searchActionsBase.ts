...
export async function findInFilesCommand(accessor: ServicesAccessor, _args: IFindInFilesArgs = {}) {
	...
	if (Object.keys(_args).length !== 0) {
		...
		// https://github.com/microsoft/vscode/blob/8b76efe9d317d50cb5b57a7658e09ce6ebffaf36/src/dc/workbench/contrib/searchEditor/browser/searchEditorActions.ts#L152-L158
