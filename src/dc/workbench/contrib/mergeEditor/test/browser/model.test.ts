		...
		await testMergeModel(
			{
				...
				'base': `import { h } from 'dc/base/browser/dom';\nimport { Disposable, IDisposable } from 'dc/base/common/lifecycle';\nimport { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';\nimport { EditorOption } from 'dc/editor/common/config/editorOptions';\nimport { autorun, IReader, observableFromEvent, ObservableValue } from 'dc/workbench/contrib/audioCues/browser/observable';\nimport { LineRange } from 'dc/workbench/contrib/mergeEditor/browser/model/lineRange';\n`,
				'input1': `import { h } from 'dc/base/browser/dom';\nimport { Disposable, IDisposable } from 'dc/base/common/lifecycle';\nimport { observableSignalFromEvent } from 'dc/base/common/observable';\nimport { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';\nimport { autorun, IReader, observableFromEvent } from 'dc/workbench/contrib/audioCues/browser/observable';\nimport { LineRange } from 'dc/workbench/contrib/mergeEditor/browser/model/lineRange';\n`,
				'input2': `import { h } from 'dc/base/browser/dom';\nimport { Disposable, IDisposable } from 'dc/base/common/lifecycle';\nimport { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';\nimport { autorun, IReader, observableFromEvent, ObservableValue } from 'dc/workbench/contrib/audioCues/browser/observable';\nimport { LineRange } from 'dc/workbench/contrib/mergeEditor/browser/model/lineRange';\n`,
				'result': `import { h } from 'dc/base/browser/dom';\r\nimport { Disposable, IDisposable } from 'dc/base/common/lifecycle';\r\nimport { observableSignalFromEvent } from 'dc/base/common/observable';\r\nimport { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';\r\n<<<<<<< Updated upstream\r\nimport { autorun, IReader, observableFromEvent, ObservableValue } from 'dc/workbench/contrib/audioCues/browser/observable';\r\n=======\r\nimport { autorun, IReader, observableFromEvent } from 'dc/workbench/contrib/audioCues/browser/observable';\r\n>>>>>>> Stashed changes\r\nimport { LineRange } from 'dc/workbench/contrib/mergeEditor/browser/model/lineRange';\r\n`
			},
			model => {
				assert.deepStrictEqual(model.getProjections(), {
					base: [
						`import { h } from 'dc/base/browser/dom';`,
						`import { Disposable, IDisposable } from 'dc/base/common/lifecycle';`,
						`⟦⟧₀import { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';`,
						`⟦import { EditorOption } from 'dc/editor/common/config/editorOptions';`,
						`import { autorun, IReader, observableFromEvent, ObservableValue } from 'dc/workbench/contrib/audioCues/browser/observable';`,
					...
					result: [
						...
						`import { Disposable, IDisposable } from 'dc/base/common/lifecycle';`,
						`⟦import { observableSignalFromEvent } from 'dc/base/common/observable';`,
						`⟧{1✓}₀import { CodeEditorWidget } from 'dc/editor/browser/widget/codeEditorWidget';`,
						'⟦<<<<<<< Updated upstream',
						`import { autorun, IReader, observableFromEvent, ObservableValue } from 'dc/workbench/contrib/audioCues/browser/observable';`,
						'=======',
						`import { autorun, IReader, observableFromEvent } from 'dc/workbench/contrib/audioCues/browser/observable';`,
						'>>>>>>> Stashed changes',
						`⟧{unrecognized}₁import { LineRange } from 'dc/workbench/contrib/mergeEditor/browser/model/lineRange';`,
						'',
					],
				});
			}
