...
export class ColorThemeData implements IWorkbenchColorTheme {
    ...
    private textMateThemingRules: ITextMateThemingRule[] | undefined = undefined;
    private tokenColorIndex: TokenColorIndex | undefined = undefined;
    private tokenFontIndex: TokenFontIndex | undefined = undefined;
    ...
    private addCustomTokenColors(customTokenColors: ITokenColorCustomizations) {
        for (const tokenGroup in tokenGroupToScopesMap) {
            const group = <keyof typeof tokenGroupToScopesMap>tokenGroup;
