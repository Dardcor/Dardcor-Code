 ...
 * (`src/dc/workbench/browser/media/floatingPanels.css`, `.floating-panels`).
 ...
 * layout uses (mirrors `Layout.adjustPartPositions` in `src/dc/workbench/browser/layout.ts`): the activity bar and primary side bar sit
