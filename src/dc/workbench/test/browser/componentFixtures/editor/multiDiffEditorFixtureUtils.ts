...
export function createMultiDiffEditorFixtureServices(disposableStore: DisposableStore, theme: ComponentFixtureContext['theme'], diffProviderFactory: IDiffProviderFactoryService) {
    return createEditorServices(disposableStore, {
        ...
        additionalServices: reg => {
            ...
            reg.defineInstance(IDecorationsService, new class extends mock<IDecorationsService>() {
            ...
            reg.defineInstance(IWorkspaceContextService, new class extends mock<IWorkspaceContextService>() {
                ...
                override getWorkspace(): IWorkspace { return { id: '', folders: [], configuration: undefined }; }
            }());
...
export function createMultiDiffEditorFixtureWidget(instantiationService: IInstantiationService, container: HTMLElement, diffEditorOptions?: IDiffEditorOptions) {
    ...
    return instantiationService.createInstance(MultiDiffEditorWidget, container, uiFactory, { variant: MultiDiffEditorVariant.Compact, diffEditorOptions });
}
