...
const SAMPLE_CHANGES = [
	createFileChange('src/dc/sessions/contrib/changes/browser/changesView.ts', 'modified', 42, 18),
	createFileChange('src/dc/sessions/contrib/changes/browser/sessionFilesWidget.ts', 'modified', 24, 9),
	createFileChange('src/dc/sessions/contrib/changes/browser/media/sessionFilesWidget.css', 'modified', 6, 2),
	createFileChange('src/dc/sessions/contrib/changes/test/browser/changesView.fixture.ts', 'added', 132, 0),
	createFileChange('src/dc/sessions/contrib/changes/browser/oldChangesLayout.ts', 'deleted', 0, 47),
];
