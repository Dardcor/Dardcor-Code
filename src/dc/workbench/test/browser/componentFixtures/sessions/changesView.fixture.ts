...
const SAMPLE_CHANGES = [
	...
	createFileChange('src/dc/sessions/contrib/changes/browser/checksWidget.ts', 'modified', 24, 9),
	createFileChange('src/dc/sessions/contrib/changes/browser/media/checksWidget.css', 'modified', 6, 2),
