		...
		if (args.kind === 'integrated') {
			...
			if (giveShellTimeToInitialize) {
				...
				if (terminal.state.isInteractedWith && !terminal.shellIntegration) {
					...
					await timeout(200); // mirroring https://github.com/microsoft/vscode/blob/c67ccc70ece5f472ec25464d3eeb874cfccee9f1/src/dc/workbench/contrib/terminal/browser/terminalInstance.ts#L852-L857
				}
