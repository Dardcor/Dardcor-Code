...
AppPublisher=Dardcor Corporation
AppPublisherURL=https://dardcor-code.web.id/
AppSupportURL=https://dardcor-code.web.id/
AppUpdatesURL=https://dardcor-code.web.id/
...
SetupIconFile={#RepoDir}\public\dardcor-code.ico
...
VersionInfoCompany=Dardcor Corporation
VersionInfoCopyright=Copyright (C) 2026 Dardcor Corporation. All rights reserved.
...
Type: filesandordirs; Name: "{app}\{#VersionedResourcesFolder}\resources\app\.dardcor-router"; Check: IsNotBackgroundUpdate
...
Root: {#SoftwareClassesRootKey}; Subkey: "Software\Classes\{#RegValueName}.code-workspace\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#VersionedResourcesFolder}\resources\app\public\dardcor-code.ico"; Tasks: associatewithfiles
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install VS Code for all users in this system, download the System Installer instead from https://dardcor-code.web.id/. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif
