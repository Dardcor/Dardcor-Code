...
const serverResourceIncludes = [
	...
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration.ps1',
	'out-build/dc/workbench/contrib/terminal/common/scripts/CodeTabExpansion.psm1',
	'out-build/dc/workbench/contrib/terminal/common/scripts/GitTabExpansion.psm1',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration-bash.sh',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration-env.zsh',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration-profile.zsh',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration-rc.zsh',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration-login.zsh',
	'out-build/dc/workbench/contrib/terminal/common/scripts/shellIntegration.fish',
	'out-build/dc/workbench/contrib/terminal/common/scripts/psreadline/**',

];

const serverResourceExcludes = [
	'!out-build/dc/**/{electron-browser,electron-main,electron-utility}/**',
	'!out-build/dc/editor/standalone/**',
	'!out-build/dc/workbench/**/*-tb.png',
	'!**/test/**'
];
...
const serverWithWebResourceIncludes = [
	...serverResourceIncludes,
	'out-build/dc/code/browser/workbench/*.html',
...
function getNodeVersion() {
	...
	const nodeVersion = /^(?:npm_config_)?target="(.*)"$/m.exec(npmrc)![1];
	const internalNodeVersion = /^(?:npm_config_)?ms_build_id="(.*)"$/m.exec(npmrc)![1];
