...
function makeAgentSkills(): AgentSkill[] {
  ...
  for (let i = 0; i < 22; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/DardcorCode/main/skills/omni-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/DardcorCode/blob/main/skills/omni-skill-${i}/SKILL.md`,
    });
  }
  for (let i = 0; i < 20; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/DardcorCode/main/skills/cli-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/DardcorCode/blob/main/skills/cli-skill-${i}/SKILL.md`,
    });
  }
  return skills;
}
