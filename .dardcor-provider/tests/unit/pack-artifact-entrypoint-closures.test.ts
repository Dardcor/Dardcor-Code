...
const BIN_ENTRY = path.join(ROOT, "bin", "dardcorCode.mjs");
...
test("every bin/dardcorCode.mjs local import is enforced by check:pack-artifact", () => {
  // The CLI boot path (bin/dardcorCode.mjs → bin/cli/*) is covered by allowlist PREFIXES,
