 ...
 * so they hit `/api/[...dardcorCodeApiCatchAll]` (#6424) — this suite verifies
...
const catchAll = await import(
  "../../../src/app/api/[...dardcorCodeApiCatchAll]/route.ts"
);
...
test("api catchall returns JSON 404 for unknown /v1beta/* via nested api catch-all", async () => {
  ...
  // catch-all exists, Next.js falls through to /api/[...dardcorCodeApiCatchAll].
