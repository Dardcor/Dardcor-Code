...
// dardcorCode_web_search tool must use the FLAT function shape ({ type, name }), not the
...
// the tool has to be converted to the dardcorCode_web_search function fallback (which the
