...
import { REGISTRY } from "@dardcorCode/open-sse/config/providers/index.ts";
import { FREE_MODEL_BUDGETS } from "@dardcorCode/open-sse/config/freeModelCatalog.data.ts";
...
// fabricated (copied from DardcorCode's own Anthropic catalog) and live-verified
