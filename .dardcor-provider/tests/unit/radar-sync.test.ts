...
test("syncRadar: valid signature => cache updated, payload byte-identical to fixture", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(FIXTURE_BYTES, { "x-dardcorCode-feed-signature": sig })
      )) as unknown as typeof globalThis.fetch,
...
test("syncRadar: tampered bytes => invalid_signature, cache untouched", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(tampered, { "x-dardcorCode-feed-signature": sig })
      )) as unknown as typeof globalThis.fetch,
  });
...
test("syncRadar: valid sig over garbage JSON => invalid_schema, cache untouched", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(garbageBytes, { "x-dardcorCode-feed-signature": sig })
      )) as unknown as typeof globalThis.fetch,
  });
...
test("syncRadar: version floor — incoming newer => updated", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(newerBytes, { "x-dardcorCode-feed-signature": sig })
      )) as unknown as typeof globalThis.fetch,
    now: () => new Date("2026-08-03T12:00:00Z"),
  });
...
test("syncRadar: sends Authorization header when supporter key exists", async () => {
  ...
  await syncMod.syncRadar({
    ...
    fetch: ((url: string, init: RequestInit) => {
      ...
      return Promise.resolve(mockResponse(FIXTURE_BYTES, { "x-dardcorCode-feed-signature": sig }));
    }) as unknown as typeof globalThis.fetch,
    now: () => new Date("2026-08-03T12:00:00Z"),
  });
...
// ===========================================================================
// syncRadar — served-tier header (x-dardcorCode-feed-tier)
//
...
// client MUST trust the `x-dardcorCode-feed-tier` response header — the
...
test("syncRadar: header 'community' overrides body tier:'live' — cache + result use community", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(bytes, {
          "x-dardcorCode-feed-signature": sig,
          "x-dardcorCode-feed-tier": "community",
        })
      )) as unknown as typeof globalThis.fetch,
    now: () => new Date("2026-08-03T12:00:00Z"),
  });
...
test("syncRadar: header absent => falls back to body tier (older server)", async () => {
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(bytes, { "x-dardcorCode-feed-signature": sig }) // no tier header
      )) as unknown as typeof globalThis.fetch,
    now: () => new Date("2026-08-03T12:00:00Z"),
  });
  ...
  const result = await syncMod.syncRadar({
    ...
    fetch: (() =>
      Promise.resolve(
        mockResponse(bytes, {
          "x-dardcorCode-feed-signature": sig,
          "x-dardcorCode-feed-tier": "premium", // arbitrary/garbage header value
        })
      )) as unknown as typeof globalThis.fetch,
    now: () => new Date("2026-08-03T12:00:00Z"),
  });
