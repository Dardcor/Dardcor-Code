...
describe("bin/dardcorCode.mjs MCP path handling", () => {
  it("pathToFileURL converts Windows paths to valid file:// URLs", () => {
    ...
    const testPath = "C:\\Users\\test\\projects\\DardcorCode\\bin\\mcp-server.mjs";
  ...
  it("pathToFileURL converts Unix paths to valid file:// URLs", () => {
    ...
    const testPath = "/home/user/projects/DardcorCode/bin/mcp-server.mjs";
    const fileUrl = pathToFileURL(testPath);
