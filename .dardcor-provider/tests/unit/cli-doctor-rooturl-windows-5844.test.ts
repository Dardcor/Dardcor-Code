...
test("old `new URL(...).pathname` pattern produces the buggy /C: prefix on a Windows file URL", () => {
  const windowsFileUrl = "file:///C:/Users/x/node_modules/dardcorCode/bin/cli/commands/doctor.mjs";
  ...
  assert.equal(buggyPathname, "/C:/Users/x/node_modules/dardcorCode/bin/cli/commands/doctor.mjs");
});
