...
} from "@dardcorCode/open-sse/handlers/chatCore/responseHeaders.ts";
...
test("streaming path strips hop-by-hop and spoofed DardcorCode headers", () => {
  const upstream = new Headers({
    connection: "keep-alive, x-remove-me",
    "keep-alive": "timeout=5",
    "proxy-authenticate": "Basic realm=upstream",
    "x-remove-me": "connection-scoped",
    "x-dardcorCode-provider": "spoofed-provider",
