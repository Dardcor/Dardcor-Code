 ...
 *
 * Scope (minimal): only models that DardcorCode already references throughout
 ...
 * provider registry. We do NOT restore models DardcorCode deliberately curated
 * out (e.g. o1, gpt-4-turbo) nor re-add embedding/TTS/image entries that
 * DardcorCode deliberately keeps in their own typed registries
