...
import { normalizeClaudeHaikuConstraints } from "@dardcorCode/open-sse/services/claudeHaikuConstraints.ts";
...
// Several DardcorCode paths can still emit these on Haiku targets:
