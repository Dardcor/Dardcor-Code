/**
 * Tests for CLI Memory Sanitization (bin/dardcorCode.mjs)
 *
 * Tests cover:
...
describe("CLI Memory Limit Sanitization", () => {
  /**
   * Replicate the memory sanitization logic from bin/dardcorCode.mjs
   */
...
describe("CLI .env File Loading", () => {
  /**
   * Simulate the .env parsing logic from bin/dardcorCode.mjs
   */
