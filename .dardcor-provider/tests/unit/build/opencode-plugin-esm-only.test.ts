...
// Regression guard for #3883: the @dardcorCode/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@dardcorCode/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@dardcorCode/opencode-plugin/tsup.config.ts", import.meta.url);
