...
function makeSkill(overrides: Partial<AgentSkill> = {}): AgentSkill {
  return {
    ...
    rawUrl: "https://raw.githubusercontent.com/diegosouzapw/DardcorCode/refs/heads/main/skills/omni-providers/SKILL.md",
    githubUrl: "https://github.com/diegosouzapw/DardcorCode/blob/main/skills/omni-providers/SKILL.md",
    ...overrides,
  };
}
