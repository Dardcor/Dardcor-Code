 ...
 *
 * DardcorCode's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to DardcorCode's TS
 * fork and DardcorCode's existing root-detection (`isRoot()`).
 */
