 ...
 *     DardcorCode self-loop, Google's Gemini OpenAI-compat endpoint).
...
test("#2232 — DardcorCode-internal providers default to self-loop when no env vars set", () => {
  clearEnv();
  // Non-standard prefixes (kr/, if/, pol/, groq/) should use DardcorCode self-loop
