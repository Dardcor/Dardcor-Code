...
// Regression test for GH #6677: `dardcorCode health` calls GET /api/health, but the
...
test("GH #6677: dardcorCode health should succeed against a server that only implements /api/monitoring/health", async () => {
