...
// remote DardcorCode deployments where the CLI lives on the user's laptop, not
...
vi.mock("next-intl", () => ({
  useTranslations: () => (key: string, values?: Record<string, unknown>) => {
    const messages: Record<string, string> = {
      ...
      installCliPrompt:
        "Manual configuration is still available if DardcorCode is deployed on a remote server.",
