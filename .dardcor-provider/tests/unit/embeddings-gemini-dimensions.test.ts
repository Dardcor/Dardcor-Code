...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "dardcorCode-embeddings-gemini-dim-"));
...
// so DardcorCode must forward `outputDimensionality` alongside `dimensions` for Gemini
