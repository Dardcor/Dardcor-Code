...
import { detectCompressionLanguage } from "@dardcorCode/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@dardcorCode/open-sse/services/compression/caveman.ts";
