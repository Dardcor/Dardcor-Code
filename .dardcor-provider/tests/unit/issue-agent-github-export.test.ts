...
test("normalizeGitHubIssueExport reads GitHub REST issue plus comments shape", () => {
  const normalized = normalizeGitHubIssueExport({
    issue: {
      ...
      html_url: "https://github.com/KooshaPari/DardcorCode/issues/6059",
    },
    comments: [
  ...
  assert.equal(normalized.issueUrl, "https://github.com/KooshaPari/DardcorCode/issues/6059");
...
test("normalizeGitHubIssueExport reads flat issue export shape", () => {
  const normalized = normalizeGitHubIssueExport({
    ...
    url: "https://github.com/KooshaPari/DardcorCode/pull/6085",
    comments: [{ author: "human", body: "review please", isBot: false }],
  });

  assert.equal(normalized.issueUrl, "https://github.com/KooshaPari/DardcorCode/pull/6085");
