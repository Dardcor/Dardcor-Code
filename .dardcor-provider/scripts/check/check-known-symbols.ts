 ...
 *
 * Sources:
 *   - MCP_TOOLS (33 base tools: dardcorCode_* + compression + agent_skills)
 *   - memoryTools (3): dardcorCode_memory_*
 *   - skillTools (4): dardcorCode_skills_*
...
export const KNOWN_MCP_TOOL_NAMES: readonly string[] = [
  ...
  "dardcorCode_compression_status",
  "dardcorCode_compression_configure",
  "dardcorCode_set_compression_engine",
  "dardcorCode_list_compression_combos",
  "dardcorCode_compression_combo_stats",
  ...
  // memoryTools (3)
  "dardcorCode_memory_search",
  "dardcorCode_memory_add",
  "dardcorCode_memory_clear",
  // skillTools (4)
  "dardcorCode_skills_list",
  "dardcorCode_skills_enable",
  "dardcorCode_skills_execute",
  "dardcorCode_skills_executions",
  // gamificationTools (8)
...
async function main(): Promise<void> {
  ...
  const executorsMod = await import("@dardcorCode/open-sse/executors/index.ts");
  ...
  const strategyDispatchMod =
    await import("@dardcorCode/open-sse/services/combo/strategyDispatch.ts");
  ...
  // ── (3) Translator pairs ──────────────────────────────────────────────────
  await import("@dardcorCode/open-sse/translator/bootstrap.ts").then((m) =>
    (m.bootstrapTranslatorRegistry as () => void)()
  );
  const formatsMod = await import("@dardcorCode/open-sse/translator/formats.ts");
  const registryMod = await import("@dardcorCode/open-sse/translator/registry.ts");
  ...
  const { MCP_TOOLS } = await import("@dardcorCode/open-sse/mcp-server/schemas/tools.ts");
  const { memoryTools } = await import("@dardcorCode/open-sse/mcp-server/tools/memoryTools.ts");
  const { skillTools } = await import("@dardcorCode/open-sse/mcp-server/tools/skillTools.ts");
  const { gamificationTools } =
    await import("@dardcorCode/open-sse/mcp-server/tools/gamificationTools.ts");
  const { pluginTools } = await import("@dardcorCode/open-sse/mcp-server/tools/pluginTools.ts");
  const { notionTools } = await import("@dardcorCode/open-sse/mcp-server/tools/notionTools.ts");
  const { obsidianTools } = await import("@dardcorCode/open-sse/mcp-server/tools/obsidianTools.ts");
