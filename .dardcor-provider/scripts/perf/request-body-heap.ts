 ...
 * import — the benchmark must never touch the operator's real ~/.dardcorCode store.
 *
...
const TMP_DATA_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "dardcorCode-heapbench-"));
