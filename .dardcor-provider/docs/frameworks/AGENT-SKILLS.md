...
- A **GitHub raw URL** for live fetch: `https://raw.githubusercontent.com/diegosouzapw/Dardcor Code/refs/heads/main/skills/{id}/SKILL.md`
...
- [MCP-SERVER.md](./MCP-SERVER.md) — MCP tool catalog (`Dardcor Code_agent_skills_*` tools)
