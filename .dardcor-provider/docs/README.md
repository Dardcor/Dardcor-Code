...
# Dardcor Code Documentation

Navigable index of the Dardcor Code documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using Dardcor Code — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run Dardcor Code in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let Dardcor Code pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of Dardcor Code.
...
- [TIERS.md](guides/TIERS.md) — Dardcor Code tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running Dardcor Code under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing Dardcor Code remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with Dardcor Code.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with Dardcor Code.
...
- [OMNIROUTE_VS_ALTERNATIVES.md](comparison/OMNIROUTE_VS_ALTERNATIVES.md) — how Dardcor Code compares to alternatives.
