...
Mermaid sources (`.mmd`) and exported SVGs for Dardcor Code v3.8.0 architecture flows.
...
| [why-pain-fix.svg](./why-pain-fix.svg)                 | README.md (root) | Animated "Why Dardcor Code" 10-row pain-vs-fix ledger (15s green row sweep). Edit the SVG directly — there is no `.mmd` source.                                                                                              |
