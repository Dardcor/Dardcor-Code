...
> Last updated: 2026-06-28 — Dardcor Code v3.8.40
>
...
├── @Dardcor Code/           # Publishable companion packages (opencode-plugin, opencode-provider)
├── skills/               # CLI/agent skill packs (cli-* + omni-* + config-codex-cli)
├── examples/             # Sample plugins + Dardcor Code-cmd-hello starter
...
Separate npm workspace (`@Dardcor Code/open-sse`). Handles request processing + provider execution.
...
| `preload.js`     | IPC bridge (contextBridge → `window.Dardcor Code`)                                   |
...
| File                                                                                                        | Purpose                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `Dardcor Code.mjs`                                                                                             | Main CLI entry — `Dardcor Code serve`, `Dardcor Code setup`, `Dardcor Code doctor`, `Dardcor Code providers`, `Dardcor Code combos`, etc. |
...
| File                         | Purpose                                                                            |
| ---------------------------- | ---------------------------------------------------------------------------------- |
| `skills/Dardcor Code*/SKILL.md` | 10 skill manifests for external AI agents (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | External CLI integrations + Internal Dardcor Code CLI                                    |
...
- **`_mono_repo/`** — historic subprojects (Dardcor CodeCloud, Dardcor CodeSite, vscode-extension)
