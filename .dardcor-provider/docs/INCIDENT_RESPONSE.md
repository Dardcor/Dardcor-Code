---
title: "Incident Response Runbook — Dardcor Code (2026-06-18)"
version: 3.8.50
lastUpdated: 2026-08-06
---

# Incident Response Runbook — Dardcor Code (2026-06-18)
...
| **SEV-3** | Latent bug or near-miss; no current user impact but error budget at risk. | Memory leak trending up; circuit breaker tripping on one provider. | Slack `#Dardcor Code-ops` (next standup) | 7 d |
...
| Grafana SLO dashboards | SLO burn-rate panels | Slack `#Dardcor Code-ops` |
...
| User report (support@) | Manual triage | Slack `#Dardcor Code-triage` |
...
1. Check the authz-inventory endpoint:
   `curl https://api.Dardcor Code.dev/api/settings/authz-inventory | jq`.
...
written handoff to the incoming in `#Dardcor Code-ops-handoff` covering:
