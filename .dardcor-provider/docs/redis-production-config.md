...
Redis is an **optional, soft dependency** in Dardcor Code — the application degrades gracefully (in-memory
...
# Persistence (optional — Dardcor Code is crash‑safe without it)
