---
title: "🗜️ Prompt Compression Guide — Dardcor Code"
version: 3.8.40
lastUpdated: 2026-06-28
---

# 🗜️ Prompt Compression Guide — Dardcor Code
...
Dardcor Code implements a modular prompt compression pipeline that runs **proactively** before requests hit upstream providers. This means your token savings happen transparently — no changes needed to your workflow.
...
Dardcor Code documents compression savings from two sources: upstream project benchmarks and
Dardcor Code's own engine composition.
...
For overlapping tool/context payloads, the default Dardcor Code combo stacks the engines:
...
Send the `x-Dardcor Code-compression` request header to override the compression plan for a single
...
The applied plan is echoed back in the `X-Dardcor Code-Compression: <mode>; source=<source>` response
...
Beyond the 7 standard modes, Dardcor Code includes several advanced compression
