...
**Cause:** You are running a Node.js version outside Dardcor Code's approved secure runtime floor. The most common case is running an older Node 20, 22, or 24 patch level that falls below the patched security floor Dardcor Code requires.
