...
**Dardcor Code** — pinagsamang AI proxy/router. Isang endpoint, 160+ LLM providers, auto-fallback.
...
Ang Dardcor Code ay may tatlong kaugnay ngunit magkakaibang mekanismo ng pansamantalang pagkabigo. Panatilihing hiwalay ang kanilang saklaw kapag nag-debug ng pag-uugali ng routing. Tingnan ang
...
- **Data directory**: `DATA_DIR` env var, default sa `~/.Dardcor Code/`
