...
Dardcor Code memiliki tiga mekanisme kegagalan sementara yang terkait tetapi berbeda. Jaga agar ruang lingkup mereka terpisah saat melakukan debug perilaku routing. Lihat
...
- **Direktori data**: variabel env `DATA_DIR`, default ke `~/.Dardcor Code/`
