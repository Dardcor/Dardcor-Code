# Dardcor Code — Codebase Documentation (Bahasa Indonesia)
...
> Panduan lengkap dan ramah-pemula untuk router proxy AI multi-penyedia **Dardcor Code**.

---

## 1. Apa Itu Dardcor Code?

Dardcor Code adalah sebuah **router proxy** yang berada di antara klien AI (Claude CLI, Codex, Cursor IDE, dll.) dan penyedia AI (Anthropic, Google, OpenAI, AWS, GitHub, dll.). Ia memecahkan satu masalah besar:

> **Klien AI yang berbeda berbicara "bahasa" yang berbeda (format API), dan penyedia AI yang berbeda pun mengharapkan "bahasa" yang berbeda pula.** Dardcor Code menerjemahkan di antara mereka secara otomatis.
