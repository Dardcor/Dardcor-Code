# Dardcor Code — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi Dardcor Code pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout Dardcor Code Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [Dardcor CodeCloud/README.md](../Dardcor CodeCloud/README.md).
...
| 20128 | Dardcor Code   | Hanya localhost (melalui nginx) |
