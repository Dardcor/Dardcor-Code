...
Panduan ini mendokumentasikan standar infrastruktur jaringan terbaik untuk mengamankan **Dardcor Code** dan mengekspos aplikasi Anda ke internet secara aman, **tanpa membuka satu pun port (Zero Inbound)**.

## Apa yang Telah Dilakukan pada VM Anda?

Kami mengaktifkan Dardcor Code dalam mode **Split-Port** melalui PM2:
...
3. Klik **Add a Tunnel**, pilih **Cloudflared**, dan beri nama `Dardcor Code-VM`.
...
- **Subdomain:** `Dardcor Code` atau `panel`
...
2. Pilih **Self-hosted**.
3. Di **Application name**, masukkan `Panel Dardcor Code`.
4. Di **Application domain**, masukkan `Dardcor Code.domainanda.com` (sama dengan yang Anda buat di "Rute 2").
5. Klik **Next**.
...
3. Klik **Create rule**.
4. **Name:** `Anti-Penyalahgunaan Dardcor Code API`
...
2. Dardcor Code hanya berkomunikasi melalui HTTPS keluar (`cloudflared`) dan tidak menerima koneksi TCP langsung dari internet.
