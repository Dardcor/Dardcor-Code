# Dokumentasi Server A2A Dardcor Code (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — Dardcor Code sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi Dardcor Code.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas Dardcor Code. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
