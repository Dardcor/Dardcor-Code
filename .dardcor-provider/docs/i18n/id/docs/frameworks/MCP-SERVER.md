# Dokumentasi Server MCP Dardcor Code (Bahasa Indonesia)
...
Dardcor Code MCP sudah tersedia secara bawaan. Jalankan dengan:
...
| Alat                            | Deskripsi                                                         |
| :------------------------------ | :---------------------------------------------------------------- |
| `Dardcor Code_get_health`          | Kesehatan gateway, pemutus sirkuit, uptime                        |
| `Dardcor Code_list_combos`         | Semua combo yang dikonfigurasi beserta modelnya                   |
| `Dardcor Code_get_combo_metrics`   | Metrik performa untuk combo tertentu                              |
| `Dardcor Code_switch_combo`        | Ganti combo aktif berdasarkan ID/nama                             |
| `Dardcor Code_check_quota`         | Status kuota per penyedia atau semua penyedia                     |
| `Dardcor Code_route_request`       | Kirim penyelesaian chat melalui Dardcor Code                         |
| `Dardcor Code_cost_report`         | Analitik biaya untuk periode waktu tertentu                       |
| `Dardcor Code_list_models_catalog` | Katalog model lengkap beserta kemampuannya                        |

## Alat Lanjutan (8)

| Alat                               | Deskripsi                                                              |
| :--------------------------------- | :--------------------------------------------------------------------- |
| `Dardcor Code_simulate_route`         | Simulasi routing percobaan dengan pohon fallback                       |
| `Dardcor Code_set_budget_guard`       | Anggaran sesi dengan tindakan degrade/block/alert                      |
| `Dardcor Code_set_resilience_profile` | Terapkan preset conservative/balanced/aggressive                       |
| `Dardcor Code_test_combo`             | Uji langsung semua model dalam combo melalui permintaan upstream nyata |
| `Dardcor Code_get_provider_metrics`   | Metrik terperinci untuk satu penyedia                                  |
| `Dardcor Code_best_combo_for_task`    | Rekomendasi kesesuaian tugas beserta alternatifnya                     |
| `Dardcor Code_explain_route`          | Jelaskan keputusan routing yang lalu                                   |
| `Dardcor Code_get_session_snapshot`   | Status sesi lengkap: biaya, token, kesalahan                           |
