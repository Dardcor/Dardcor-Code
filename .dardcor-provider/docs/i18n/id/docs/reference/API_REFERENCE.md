...
Referensi lengkap untuk semua titik akhir API Dardcor Code.
...
| ------------------------ | --------- | ------------------------------------------------------------ |
| `X-Dardcor Code-No-Cache`   | Permintaan | Atur ke `true` untuk melewati cache                          |
| `X-Dardcor Code-Progress`   | Permintaan | Atur ke `true` untuk event progres                           |
...
| `X-Dardcor Code-Cache`      | Respons   | `HIT` atau `MISS` (non-streaming)                            |
| `X-Dardcor Code-Idempotent` | Respons   | `true` jika dideduplikasi                                    |
| `X-Dardcor Code-Progress`   | Respons   | `enabled` jika pelacakan progres aktif                       |
| `X-Dardcor Code-Session-Id` | Respons   | ID sesi efektif yang digunakan Dardcor Code                     |
