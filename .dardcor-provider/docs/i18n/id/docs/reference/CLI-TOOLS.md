# Panduan Pengaturan Alat CLI — Dardcor Code (Bahasa Indonesia)
...
untuk menggunakan **Dardcor Code** sebagai backend terpadu, memberikan manajemen kunci terpusat,
...
Claude / Codex / OpenCode / Cline / KiloCode / Continue / Kiro / Cursor / Copilot
           │
           ▼  (semua mengarah ke Dardcor Code)
    http://YOUR_SERVER:20128/v1
           │
           ▼  (Dardcor Code meneruskan ke penyedia yang tepat)
...
| **Antigravity**    | `antigravity` | internal   | mitm            | Dardcor Code        |
...
## Langkah 1 — Dapatkan API Key Dardcor Code

1. Buka dashboard Dardcor Code → **API Manager** (`/dashboard/api-manager`)
...
export ANTHROPIC_API_KEY="sk-your-Dardcor Code-key"
...
api_key = "sk-your-Dardcor Code-key"
EOF
```
...
Atau gunakan dashboard Dardcor Code → **CLI Tools → Cline → Apply Config**.
...
Atau gunakan dashboard Dardcor Code → **CLI Tools → KiloCode → Apply Config**.
...
# CLI ini menggunakan autentikasinya sendiri — Dardcor Code tidak diperlukan sebagai backend untuk Kiro CLI itu sendiri.
# Gunakan kiro-cli bersama Dardcor Code untuk alat lainnya.
kiro-cli status
```
...
> **Catatan:** Cursor merutekan permintaan melalui cloudnya sendiri. Untuk integrasi Dardcor Code,
> aktifkan **Cloud Endpoint** di Pengaturan Dardcor Code dan gunakan URL domain publik Anda.

Melalui GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: kunci Dardcor Code Anda

---

## Konfigurasi Otomatis Dashboard

Dashboard Dardcor Code mengotomatiskan konfigurasi untuk sebagian besar alat:
...
**Droid** dan **OpenClaw** adalah agen AI yang dibangun langsung ke dalam Dardcor Code — tidak perlu instalasi.
Keduanya berjalan sebagai rute internal dan menggunakan perutean model Dardcor Code secara otomatis.
...
| ------------------------- | --------------------------------- | ------------------------------------------ |
| `Connection refused`      | Dardcor Code tidak berjalan          | `pm2 start Dardcor Code`                      |
...
```bash
# Instal semua CLI dan konfigurasi untuk Dardcor Code (ganti dengan kunci dan URL server Anda)
OMNIROUTE_URL="http://localhost:20128/v1"
OMNIROUTE_KEY="sk-your-Dardcor Code-key"
...
source ~/.bashrc
echo "✅ All CLIs installed and configured for Dardcor Code"
```
