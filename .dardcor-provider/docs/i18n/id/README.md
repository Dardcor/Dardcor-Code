# 🚀 Dardcor Code — Gateway AI Gratis (Bahasa Indonesia)
...
![NPM Downloads](https://img.shields.io/npm/dw/Dardcor Code?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/Dardcor Code?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/Dardcor Code?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/Dardcor Code)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/diegosouzapw/Dardcor Code/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/diegosouzapw/Dardcor Code?logo=star&style=flat)](https://github.com/diegosouzapw/Dardcor Code/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/diegosouzapw/Dardcor Code?logo=issue)](https://github.com/diegosouzapw/Dardcor Code/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/diegosouzapw/Dardcor Code?logo=law)](https://github.com/diegosouzapw/Dardcor Code/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/diegosouzapw/Dardcor Code?logo=history&logoColor=white)](https://github.com/diegosouzapw/Dardcor Code/commits/main)
...
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/diegosouzapw/Dardcor Code?logo=file-code&logoColor=white)](https://github.com/diegosouzapw/Dardcor Code)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/diegosouzapw/Dardcor Code?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/diegosouzapw/Dardcor Code/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/diegosouzapw/Dardcor Code?logo=tag&logoColor=white)](https://github.com/diegosouzapw/Dardcor Code/tags)
...
[![fork](https://custom-icon-badges.demolab.com/github/forks/diegosouzapw/Dardcor Code?logo=fork)](https://github.com/diegosouzapw/Dardcor Code/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/diegosouzapw/Dardcor Code?logo=eye)](https://github.com/diegosouzapw/Dardcor Code/watchers)

[![License](https://img.shields.io/github/license/diegosouzapw/Dardcor Code)](https://github.com/diegosouzapw/Dardcor Code/blob/main/LICENSE)
...
[🌐 Website](https://Dardcor Code.online) • [🚀 Mulai Cepat](#-quick-start) • [💡 Fitur](#-key-features) • [📖 Dokumentasi](#-documentation) • [💰 Harga](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainDardcor Code.png" alt="Dardcor Code Dashboard" width="800"/>
</div>
...
_Hubungkan IDE atau alat CLI berbasis AI apa pun melalui Dardcor Code — gateway API gratis untuk coding tanpa batas._
...
<sub>📡 Semua agen terhubung melalui <code>http://localhost:20128/v1</code> atau <code>http://cloud.Dardcor Code.online/v1</code> — satu konfigurasi, model dan kuota tak terbatas</sub>

---

## 🤔 Mengapa Dardcor Code?
...
- **Issues**: [github.com/diegosouzapw/Dardcor Code/issues](https://github.com/diegosouzapw/Dardcor Code/issues)
...
## 🎯 Apa yang Diselesaikan Dardcor Code — 30 Masalah Nyata & Kasus Penggunaan

> **Setiap developer yang menggunakan alat AI menghadapi masalah ini setiap hari.** Dardcor Code dibangun untuk menyelesaikannya semua — dari pembengkakan biaya hingga pemblokiran regional, dari alur OAuth yang rusak hingga operasi protokol dan observabilitas enterprise.
...
**Cara Dardcor Code menyelesaikannya:**
...
**Bagaimana Dardcor Code menyelesaikannya:**
...
- **Laporan Info Sistem** — `npm run system-info` menghasilkan `system-info.txt` dengan lingkungan lengkap Anda (versi Node, versi Dardcor Code, OS, alat CLI, status Docker/PM2). Lampirkan saat melaporkan masalah untuk triase instan.
...
- **instal global npm** — `npm install -g Dardcor Code && Dardcor Code` — selesai
...
- Mulai cepat bawaan untuk `Dardcor Code --mcp` dan orientasi klien
...
```txt
1) Start MCP transport (`Dardcor Code --mcp`) for tool-driven operations
...
Pengguna Arch Linux dapat menginstal [AUR package](https://aur.archlinux.org/packages/Dardcor Code-bin), yang menginstal Dardcor Code dan menyediakan layanan pengguna systemd:
...
| Command                 | Description                                                     |
| ----------------------- | --------------------------------------------------------------- |
| `Dardcor Code`             | Mulai server (`PORT=20128`, API dan dasbor pada port yang sama) |
| `Dardcor Code --port 3000` | Set canonical/API port to 3000                                  |
| `Dardcor Code --mcp`       | Mulai server MCP (stdio transport)                              |
| `Dardcor Code --no-open`   | Don't auto-open browser                                         |
| `Dardcor Code --help`      | Show help                                                       |
...
Saat Anda tidak lagi memerlukan Dardcor Code, kami menyediakan dua skrip cepat untuk penghapusan bersih:

| Command                  | Action                                                                                       |
| ------------------------ | -------------------------------------------------------------------------------------------- |
| `npm run uninstall`      | Menghapus aplikasi sistem tetapi **menyimpan DB dan konfigurasi Anda** di `~/.Dardcor Code`.    |
| `npm run uninstall:full` | Menghapus aplikasi DAN secara permanen **menghapus semua konfigurasi, kunci, dan database**. |

> Catatan: Untuk menjalankan perintah ini, navigasikan ke folder proyek Dardcor Code (jika Anda mengkloningnya) dan jalankan. Alternatifnya, jika diinstal secara global, Anda cukup menjalankan `npm uninstall -g Dardcor Code`.
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Kesenjangan maksimum antara potongan streaming sebelum Dardcor Code membatalkan aliran SSE                                                                                      |
...
Untuk upstream yang kompatibel dengan Kode Claude (`anthropic-compatible-cc-*`), Dardcor Code juga memperoleh header `X-Stainless-Timeout` keluar dari batas waktu pengambilan yang diselesaikan sehingga batas waktu baca sisi penyedia tetap selaras dengan konfigurasi env Anda.

Untuk reverse proxy pihak ketiga yang kompatibel dengan Claude Code, Dardcor Code tetap menggunakan default
...
`cache_control`, Dardcor Code tidak memasukkan penanda milik jembatan.
...
Untuk permintaan streaming, `FETCH_TIMEOUT_MS` hanya mencakup pengaturan koneksi/menunggu respons upstream pertama. Setelah aliran aktif, Dardcor Code hanya akan dibatalkan pada keadaan terhenti sebenarnya (`STREAM_IDLE_TIMEOUT_MS`) atau tubuh Undici tidak aktif (`FETCH_BODY_TIMEOUT_MS`).

Jika Anda menjalankan Dardcor Code di belakang Nginx, Caddy, Cloudflare, atau proksi terbalik lainnya, pastikan proksi tersebut
waktu tunggu juga lebih tinggi daripada waktu tunggu aliran/pengambilan Dardcor Code Anda.
...
### 3) Arahkan alat pengkodean Anda ke Dardcor Code
...
- `Dardcor Code_get_health`
- `Dardcor Code_list_combos`
...
Untuk pengguna Void Linux, Anda dapat membuat paket asli menggunakan `xbps-src`. Simpan blok ini sebagai `srcpkgs/Dardcor Code/template`:
...
Dardcor Code tersedia sebagai image Docker publik di [Docker Hub](https://hub.docker.com/r/diegosouzapw/Dardcor Code).
...
- Terowongan Cepat tidak dipulihkan secara otomatis setelah Dardcor Code atau kontainer dimulai ulang. Aktifkan kembali dari dasbor bila diperlukan.
...
- SQLite berjalan dalam mode WAL. `docker stop` harus dibiarkan selesai sehingga Dardcor Code dapat memeriksa kembali perubahan terbaru ke `storage.sqlite`.
...
- Setel `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` jika Anda ingin Dardcor Code menggunakan biner yang sudah ada alih-alih mengunduhnya.

**Menggunakan Docker Compose dengan Caddy (HTTPS Auto-TLS):**

Dardcor Code dapat diekspos dengan aman menggunakan penyediaan SSL otomatis Caddy. Pastikan data DNS A domain Anda mengarah ke IP server Anda.

```yaml
services:
  Dardcor Code:
    image: diegosouzapw/Dardcor Code:latest
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://Dardcor Code:20128
...
| ------------------------ | -------- | ------ | --------------------- |
| `diegosouzapw/Dardcor Code` | `latest` | ~250MB | Latest stable release |
| `diegosouzapw/Dardcor Code` | `3.6.2`  | ~250MB | Current version       |

---

## 🖥️ Aplikasi Desktop — Offline & Selalu Aktif

> 🆕 **BARU!** Dardcor Code kini tersedia sebagai **aplikasi desktop asli** untuk Windows, macOS, dan Linux.

Jalankan Dardcor Code sebagai aplikasi desktop mandiri — tanpa terminal, tanpa browser, tanpa internet untuk model lokal. Aplikasi berbasis Electron meliputi:

- 🖥️ **Jendela Asli** — Jendela aplikasi khusus dengan integrasi baki sistem
- 🔄 **Mulai Otomatis** — Luncurkan Dardcor Code saat login sistem
...
Saat diminimalkan, Dardcor Code ada di baki sistem Anda dengan tindakan cepat:
...
**Tanpa biaya. Jangan pernah berhenti melakukan pengkodean.** Konfigurasikan ini sebagai satu kombo Dardcor Code dan semua fallback terjadi secara otomatis — tidak pernah ada peralihan manual.
...
> Semua model di bawah **100% gratis tanpa memerlukan kartu kredit**. Dardcor Code melakukan rute otomatis di antara keduanya ketika satu kuota habis — gabungkan semuanya untuk kombo $0 yang tidak dapat dipecahkan.
...
Dardcor Code v3.6 dibangun sebagai platform operasional, bukan hanya proxy relai.
...
Ketika kuota, tarif, atau kesehatan gagal, Dardcor Code secara otomatis berpindah ke kandidat berikutnya tanpa peralihan manual.
...
Dardcor Code menyertakan kerangka evaluasi bawaan untuk menguji kualitas respons LLM terhadap rangkaian emas. Akses melalui **Analytics → Evals** di dasbor.

### Golden Set Bawaan

"Dardcor Code Golden Set" yang dimuat sebelumnya berisi kasus uji untuk:
...
2. Jalankan `Dardcor Code_get_health`.
3. Jalankan `Dardcor Code_list_combos`.
...
**Kiat Pro:** Gunakan Opus untuk tugas kompleks, Soneta untuk kecepatan. Dardcor Code melacak kuota per model!
...
- Perilaku rotasi: Dardcor Code merutekan ke akun Codex berikutnya yang memenuhi syarat secara otomatis.
...
**Kiat Pro:** API yang kompatibel dengan OpenAI — bekerja secara lancar dengan terjemahan format Dardcor Code!
...
> **Catatan:** OpenClaw hanya berfungsi dengan Dardcor Code lokal. Gunakan `127.0.0.1` alih-alih `localhost` untuk menghindari masalah resolusi IPv6.
...
**Langkah 1:** Tambahkan Dardcor Code sebagai penyedia khusus:

```bash
opencode
/connect
# Select "Other" → Enter ID: "Dardcor Code" → Enter your Dardcor Code API key
```
...
```bash
/models
# Select any Dardcor Code model from the list
```

> **Tips:** Tambahkan model apa pun yang tersedia di titik akhir Dardcor Code `/v1/models` Anda ke bagian `models`. Gunakan format `provider/model-id` dari dasbor Dardcor Code Anda.
...
- Disegarkan secara otomatis oleh Dardcor Code
...
- Dardcor Code v1.0.6+ menyertakan validasi fallback melalui penyelesaian obrolan
...
> **⚠️ Penting bagi pengguna yang menjalankan Dardcor Code di VPS, Docker, atau server jarak jauh mana pun**

Kredensial OAuth yang disertakan dalam Dardcor Code didaftarkan **hanya untuk `localhost`**. Saat Anda mengakses Dardcor Code di server jarak jauh (misalnya `https://Dardcor Code.myserver.com`), Google menolak autentikasi dengan:
...
- Nama: apa pun yang Anda suka (mis. `Dardcor Code Remote`)
...
1. Dardcor Code membuka URL otorisasi Google
...
4. Tempelkan URL tersebut ke bidang yang ditampilkan di modal koneksi Dardcor Code
5. Klik **"Hubungkan"**
...
- **Situs Web**: [Dardcor Code.online](https://Dardcor Code.online)
- **Paket**: [npmjs.com/package/Dardcor Code](https://www.npmjs.com/package/Dardcor Code)
- **Pekerja Pelabuhan**: [hub.docker.com/r/diegosouzapw/Dardcor Code](https://hub.docker.com/r/diegosouzapw/Dardcor Code)
...
Dardcor Code memiliki **218+ fitur yang direncanakan** di berbagai fase pengembangan. Berikut adalah bidang-bidang utamanya:
...
[![Contributors](https://contrib.rocks/image?repo=diegosouzapw/Dardcor Code&max=100&columns=20&anon=1)](https://github.com/diegosouzapw/Dardcor Code/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=diegosouzapw%2FDardcor Code&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/Dardcor Code&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/Dardcor Code&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=diegosouzapw/Dardcor Code&type=date&legend=top-left" />
 </picture>
</a>
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://Dardcor Code.online">Dardcor Code.online</a></sub>
</div>
