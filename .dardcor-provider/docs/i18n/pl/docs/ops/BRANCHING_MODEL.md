...
Dardcor Code stosuje model wydań oparty na **równoległych cyklach**: dedykowana gałąź
...
```bash
gh issue list --repo diegosouzapw/Dardcor Code --label release-freeze --state open
```
