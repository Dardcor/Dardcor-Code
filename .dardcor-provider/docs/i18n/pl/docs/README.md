---
title: "Dokumentacja Dardcor Code"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Dokumentacja Dardcor Code

Nawigowalny indeks zestawu dokumentacji Dardcor Code. Tematy są pogrupowane według celu, abyś szybko znalazł to, czego potrzebujesz.
...
Proste przewodniki po korzystaniu z Dardcor Code — bez wymaganej wiedzy technicznej.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — zainstaluj i uruchom Dardcor Code w 3 minuty.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — pozwól Dardcor Code wybrać dla Ciebie najlepsze AI.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — pierwsza konfiguracja Dardcor Code.
...
- [TIERS.md](guides/TIERS.md) — poziomy Dardcor Code wyjaśnione (przewodnik użytkownika).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — uruchamianie Dardcor Code w Dockerze.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — udostępnianie Dardcor Code zdalnie + tokeny z zakresem (scoped tokens).
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — główna tabela integracji CLI `setup-*`.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI z Dardcor Code.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI z Dardcor Code.
...
- [OMNIROUTE_VS_ALTERNATIVES.md](comparison/OMNIROUTE_VS_ALTERNATIVES.md) — jak Dardcor Code wypada na tle alternatyw.
