...
Dostawcy Web Cookie pozwalają Dardcor Code korzystać z usługi AI przez istniejącą sesję przeglądarki zamiast klucza API. Są przydatne, gdy masz już dostęp do usługi przez stronę internetową i chcesz, aby Dardcor Code używał tej samej uwierzytelnionej sesji.
...
Dla większości dostawców Web Cookie właśnie tę wartość należy wkleić do Dardcor Code.
...
## Ciasteczko działa w przeglądarce, ale nie w Dardcor Code
