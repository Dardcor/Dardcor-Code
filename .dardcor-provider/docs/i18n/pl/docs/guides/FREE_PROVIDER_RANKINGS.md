...
> **TL;DR**: Dardcor Code rankinguje swoje **darmowe** providery według jakości modeli, używając **wyników ELO Arena AI
...
Dardcor Code agreguje 160+ providerów, z których wiele udostępnia **darmowy tier** (no-auth,
...
Kategorie rankingu mapują się na kategorie zadań Dardcor Code:

| Ranking Arena | Kategorie zadań Dardcor Code                         |
| ------------- | ------------------------------------------------- |
...
- Jest **nieblokująca i nigdy nie jest fatalna** — jeśli fetch upstreamu się nie uda, Dardcor Code dalej
...
przez Dardcor Code, dzięki czemu modele da się znaleźć pod dowolną nazwą.
