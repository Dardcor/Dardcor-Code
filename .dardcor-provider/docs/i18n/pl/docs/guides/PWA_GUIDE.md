...
Dardcor Code jest dostarczany jako w pełni instalowalna Progressive Web App. Gdy otworzysz dashboard w dowolnej przeglądarce mobilnej — Android (Chrome) lub iOS (Safari) — możesz wybrać „Dodaj do ekranu głównego” i uzyskać doświadczenie zbliżone do natywnej aplikacji, bez sklepu z aplikacjami.

## Czym jest PWA?

Progressive Web App zamienia webowy dashboard Dardcor Code w coś, co wygląda i działa jak natywna aplikacja mobilna. Po zainstalowaniu:
...
1. Otwórz dashboard Dardcor Code w Chrome: `http://YOUR_IP:20128`
2. Chrome automatycznie pokaże baner **"Add Dardcor Code to Home screen"**, albo:
   - Stuknij menu **⋮** (trzy kropki) → **"Add to Home screen"** lub **"Install app"**
3. Potwierdź monity
4. Dardcor Code pojawi się na ekranie głównym jako samodzielna aplikacja

### iOS (Safari)

1. Otwórz dashboard Dardcor Code w Safari: `http://YOUR_IP:20128`
2. Stuknij przycisk **Share** (kwadrat ze strzałką)
3. Przewiń w dół i stuknij **"Add to Home Screen"**
4. Nadaj nazwę (domyślnie „Dardcor Code”) i stuknij **Add**
5. Dardcor Code pojawi się na ekranie głównym z ikoną aplikacji

### Desktop (Chrome / Edge)

1. Otwórz dashboard Dardcor Code
2. Kliknij **ikona instalacji** na pasku adresu (lub ⋮ → "Install Dardcor Code...")
3. Potwierdź monity
4. Dardcor Code otworzy się jako samodzielne okno — bez kart i paska adresu
...
Dardcor Code zawiera service worker (`sw.js`), który zapewnia inteligentne buforowanie:
...
Dardcor Code dostarcza ikony zoptymalizowane pod każdą platformę:
...
```json
{
  ...
  "description": "Dardcor Code is an AI gateway for multi-provider LLMs. One endpoint for all your AI providers.",
  "start_url": "/",
  "scope": "/",
  "display": "fullscreen",
  "orientation": "any",
...
- **Wersjonowanie cache**: `Dardcor Code-pwa-v2` — zwiększ tę wartość, aby wymusić świeży cache przy aktualizacji
...
Przy uruchamianiu Dardcor Code na Androidzie przez Termux PWA działa bezproblemowo:

1. Uruchom Dardcor Code w Termux: `npx Dardcor Code`
...
Zainstaluj PWA na dowolnym urządzeniu, które ma dostęp przeglądarkowy do serwera Dardcor Code:
