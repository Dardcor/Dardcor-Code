---
title: "Dardcor Code — Przewodnik deinstalacji"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Dardcor Code — Przewodnik deinstalacji
...
Ten przewodnik opisuje, jak czysto usunąć Dardcor Code z systemu.

---

## Szybka deinstalacja (v3.6.2+)

Dardcor Code udostępnia dwa wbudowane skrypty do czystego usunięcia:
...
To usuwa aplikację Dardcor Code, ale **zachowuje** bazę danych, konfiguracje, klucze API oraz ustawienia providerów w `~/.Dardcor Code/`. Użyj tej opcji, jeśli planujesz ponowną instalację i chcesz zachować swoją konfigurację.
...
- Pliki logów
- Wszystkie pliki w katalogu `~/.Dardcor Code/`
...
- Otwórz `Settings → Apps → Dardcor Code → Uninstall`
- Lub uruchom deinstalator NSIS z katalogu instalacji

**macOS:**

- Przeciągnij `Dardcor Code.app` z `/Applications` do Kosza
- Usuń dane: `rm -rf ~/Library/Application Support/Dardcor Code`

**Linux:**

- Usuń plik AppImage
- Usuń dane: `rm -rf ~/.Dardcor Code`
...
Dardcor Code domyślnie przechowuje dane w następujących lokalizacjach:
