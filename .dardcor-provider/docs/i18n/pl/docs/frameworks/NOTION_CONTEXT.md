...
Dardcor Code może połączyć się z workspace'em **Notion** jako **źródłem kontekstu** — bazą
...
oraz dopisywać nowe bloki — wszystko proksowane przez Dardcor Code (z retry, timeoutem
...
> strony/bazy, do których Dardcor Code ma mieć dostęp (model uprawnień Notion opiera się
...
`POST` Dardcor Code zapisuje token i od razu wykonuje testowe wyszukiwanie z 1 wynikiem;
