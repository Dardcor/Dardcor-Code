...
Dardcor Code wykrywa środowisko Docker za pomocą dwóch heurystyk:
...
2. Panel **Manual Token Import** pojawia się poniżej karty importu z keychain. Gdy
   Dardcor Code wykryje Docker, panel rozwija się automatycznie po pierwszej nieudanej
