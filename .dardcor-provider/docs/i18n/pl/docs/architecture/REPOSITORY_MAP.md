...
> Ostatnia aktualizacja: 2026-06-28 — Dardcor Code v3.8.40
>
...
├── @Dardcor Code/           # Publikowalne pakiety towarzyszące (opencode-plugin, opencode-provider)
├── skills/               # Paczki skilli CLI/agent (cli-* + omni-* + config-codex-cli)
├── examples/             # Przykładowe pluginy + starter Dardcor Code-cmd-hello
...
Osobny workspace npm (`@Dardcor Code/open-sse`). Obsługuje przetwarzanie żądań + wykonanie u providerów.
...
| `preload.js`     | Most IPC (contextBridge → `window.Dardcor Code`)                                       |
...
| Plik                                                                                                        | Cel                                                                                                                           |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `Dardcor Code.mjs`                                                                                             | Główne wejście CLI — `Dardcor Code serve`, `Dardcor Code setup`, `Dardcor Code doctor`, `Dardcor Code providers`, `Dardcor Code combos` itd. |
...
| Plik                         | Cel                                                                                       |
| ---------------------------- | ----------------------------------------------------------------------------------------- |
| `skills/Dardcor Code*/SKILL.md` | 10 manifestów skilli dla zewnętrznych agentów AI (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | Integracje zewnętrznych CLI + wewnętrzne CLI Dardcor Code                               |
...
- **`_mono_repo/`** — historyczne podprojekty (Dardcor CodeCloud, Dardcor CodeSite, vscode-extension)
