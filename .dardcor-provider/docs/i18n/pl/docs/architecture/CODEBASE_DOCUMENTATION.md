---
title: "Dokumentacja bazy kodu Dardcor Code"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Dokumentacja bazy kodu Dardcor Code

> **Wersja:** v3.8.0
> **Ostatnia aktualizacja:** 2026-06-28
> **Odbiorcy:** Inżynierowie współtworzący Dardcor Code lub budujący na nim integracje.
>
...
danych to zmienna środowiskowa `DATA_DIR`, domyślnie `~/.Dardcor Code/`.
...
├── open-sse/             Workspace silnika streamingu (@Dardcor Code/open-sse)
├── electron/             Opakowanie desktopowe (Electron 41 main + preload)
├── bin/                  Punkty wejścia CLI (Dardcor Code, reset-password)
...
| `responses.ts`, `Dardcor CodeesponseMeta.ts` | Helpery kształtu odpowiedzi                       |
...
Osobny npm workspace publikowany jako `@Dardcor Code/open-sse`. Odpowiada za
...
```
bin/
├── Dardcor Code.mjs           Główne wejście CLI (Node ESM)
...
- **Importy**: external → internal (`@/`, `@Dardcor Code/open-sse`) → relative.
