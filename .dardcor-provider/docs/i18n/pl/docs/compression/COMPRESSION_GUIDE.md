---
title: "🗜️ Przewodnik po kompresji promptów — Dardcor Code"
version: 3.8.40
lastUpdated: 2026-06-28
---

# 🗜️ Przewodnik po kompresji promptów — Dardcor Code
...
Dardcor Code implementuje modularny potok kompresji promptów, który działa **proaktywnie** zanim żądania trafią do upstreamowych providerów. Oszczędności tokenów zachodzą więc przejrzyście — bez zmian w Twoim workflow.
...
Dardcor Code dokumentuje oszczędności kompresji z dwóch źródeł: benchmarków projektów upstream oraz
własnej kompozycji silników Dardcor Code.
...
Dla nakładających się payloadów narzędzi/kontekstu domyślne combo Dardcor Code układa silniki w stos:
...
Wyślij nagłówek żądania `x-Dardcor Code-compression`, aby nadpisać plan kompresji dla pojedynczego
...
Zastosowany plan jest zwracany w nagłówku odpowiedzi `X-Dardcor Code-Compression: <mode>; source=<source>`,
...
Poza 7 standardowymi trybami Dardcor Code zawiera kilka zaawansowanych systemów kompresji,
...
} from "@Dardcor Code/open-sse/services/compression/cachingAware";
...
```ts
import { applyAging } from "@Dardcor Code/open-sse/services/compression/progressiveAging";
