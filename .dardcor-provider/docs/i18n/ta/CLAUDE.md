...
**Dardcor Code** — ஒருங்கிணைந்த AI பிராக்சி/ரூட்டர். ஒரு முடிவிடம், 160+ LLM வழங்குநர்கள், தானாகவே fallback.
...
Dardcor Code இல் மூன்று தொடர்புடைய ஆனால் தனித்துவமான தற்காலிக-தவறுகள் முறைமைகள் உள்ளன. வழிமுறை நடத்தை பிழைகளை சரிசெய்யும் போது அவற்றின் பரப்பை தனியாக வைத்திருக்கவும். ஒரு பார்வையில் வரைபடத்திற்கான
...
- **இறக்குமதிகள்**: வெளிப்புறம் → உள்ளகம் (`@/`, `@Dardcor Code/open-sse`) → தொடர்புடைய
...
- **பாதை அலியாஸ்**: `@/*` → `src/`, `@Dardcor Code/open-sse` → `open-sse/`, `@Dardcor Code/open-sse/*` → `open-sse/*`
- **இயல்புநிலை போர்ட்**: 20128 (API + dashboard ஒரே போர்டில்)
- **தரவியல் அடைவு**: `DATA_DIR` env var, இயல்பாக `~/.Dardcor Code/`
