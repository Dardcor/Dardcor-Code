...
**Dardcor Code** — enhetlig AI proxy/ruter. Ett endepunkt, 160+ LLM-leverandører, automatisk fallback.
...
Dardcor Code har tre relaterte, men distinkte mekanismer for midlertidig feil. Hold deres
...
- **Datakatalog**: `DATA_DIR` miljøvariabel, standard til `~/.Dardcor Code/`
