# Contributing to Dardcor Code (中文 (简体))
...
感谢你对 Dardcor Code 的关注！本文档将引导你从零开始参与项目贡献。
...
> **VPS 部署说明：** 远程镜像目录 `/usr/lib/node_modules/Dardcor Code/app/`
...
open-sse/                   # @Dardcor Code/open-sse 工作区
...
- **问题反馈**：[github.com/diegosouzapw/Dardcor Code/issues](https://github.com/diegosouzapw/Dardcor Code/issues)
