...
**Dardcor Code** — एकीकृत AI प्रॉक्सी/राउटर। एक एंडपॉइंट, 160+ LLM प्रदाता, स्वचालित फॉलबैक।
...
Dardcor Code में तीन संबंधित लेकिन अलग अस्थायी-फेल्योर तंत्र हैं। रूटिंग व्यवहार को डिबग करते समय उनके दायरे को अलग रखें। एक झलक के लिए [3-लेयर लचीलापन आरेख](./docs/diagrams/exported/resilience-3layers.svg) देखें (स्रोत: [docs/diagrams/resilience-3layers.mmd](./docs/diagrams/resilience-3layers.mmd))।
...
- **इम्पोर्ट्स**: बाहरी → आंतरिक (`@/`, `@Dardcor Code/open-sse`) → सापेक्ष
...
- **पथ उपनाम**: `@/*` → `src/`, `@Dardcor Code/open-sse` → `open-sse/`, `@Dardcor Code/open-sse/*` → `open-sse/*`
- **डिफ़ॉल्ट पोर्ट**: 20128 (API + डैशबोर्ड एक ही पोर्ट पर)
- **डेटा निर्देशिका**: `DATA_DIR` env var, डिफ़ॉल्ट रूप से `~/.Dardcor Code/`
