...
Este guia documenta o padrão ouro de infraestrutura de rede para proteger o **Dardcor Code** e expor sua aplicação de forma segura para a internet, **sem abrir nenhuma porta (Zero Inbound)**.

## O que foi feito na sua VM?

Nós ativamos o Dardcor Code em modo **Split-Port** através do PM2:
...
3. Clique em **Add a Tunnel**, escolha **Cloudflared** e dê o nome \`Dardcor Code-VM\`.
...
- **Subdomain:** \`Dardcor Code\` ou \`painel\`
...
3. Em **Application name**, coloque \`Painel Dardcor Code\`.
4. Em **Application domain**, coloque \`Dardcor Code.seuglobal.com.br\` (O mesmo que você fez na "Rota 2").
5. Clique em **Next**.
...
4. **Name:** \`Anti-Abuso Dardcor Code API\`
...
2. O Dardcor Code só conversa HTTPS saindo (\`cloudflared\`) e não recebendo TCP direto do mundo.
