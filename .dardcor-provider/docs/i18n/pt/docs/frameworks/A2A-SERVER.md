# Dardcor Code A2A Server Documentation (Português (Portugal))
...
| Skill              | Description                                                                                                                     |
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Routes prompts through Dardcor Code's intelligent pipeline. Returns response with routing explanation, cost, and resilience trace. |
