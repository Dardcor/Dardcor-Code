# CLI Tools Setup Guide — Dardcor Code (Português (Portugal))
...
to use **Dardcor Code** as the unified backend, giving you centralized key management,
...
1. Open the Dardcor Code dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For Dardcor Code integration,
> enable **Cloud Endpoint** in Dardcor Code Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your Dardcor Code key

---

## Dashboard Auto-Configuration

The Dardcor Code dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into Dardcor Code — no installation needed.
They run as internal routes and use Dardcor Code's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | Dardcor Code not running   | `pm2 start Dardcor Code`                      |
...
```bash
# Install all CLIs and configure for Dardcor Code (replace with your key and server URL)
