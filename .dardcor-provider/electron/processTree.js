...
//
// The embedded server is spawned via process.execPath (= dardcorCode.exe) with
// ELECTRON_RUN_AS_NODE=1, and it in turn spawns grandchildren (embedded services,
// MITM proxy, tunnels — several also dardcorCode.exe-as-node). On Windows, Node's
...
// on dardcorCode.exe, so the process "hangs in memory" after Exit and updates fail with
