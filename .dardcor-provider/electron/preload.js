/**
 * DardcorCode Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "dardcorCode-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "dardcorCode-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__dardcorCodeMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    style.textContent = `
      header,
      .dardcorCode-electron-drag-region {
        app-region: drag;
    ...
    dragRegion.className = "dardcorCode-electron-drag-region";
