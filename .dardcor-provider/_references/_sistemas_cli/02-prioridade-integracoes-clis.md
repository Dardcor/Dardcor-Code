# Prioridade de integracoes de CLIs com Dardcor Code
...
**Snapshot:** 2026-08-01  
**Objetivo:** ordenar do melhor para o pior todos os projetos tecnicamente candidatos a consumir Dardcor Code, sem remover projetos pequenos. A ordem e uma fila de pesquisa/execucao; ela nao e promessa de que todo upstream aceitara um PR.

## Como ler a prioridade

- **P0:** ja esta no catalogo Dardcor Code ou tem evidencia muito forte de endpoint customizavel; executar/consolidar primeiro.
...
Os fatores usados foram: evidencia de endpoint arbitrario, adocao/atividade, facilidade de teste, compatibilidade OpenAI/Anthropic/Gemini, maturidade, licenca, chance de PR upstream, valor para usuarios Dardcor Code e risco de protocolo.

## A. Catalogo Dardcor Code ja existente
...
| A20 | jcode | `1jehuang/jcode` | integrado e proposto upstream | aguardar issue #704; manter README Dardcor Code |
...
| A23 | Grok Build | `xai-org/grok-build` | catalogado; `~/.grok/config.toml` | provider Dardcor Code e modelos |
