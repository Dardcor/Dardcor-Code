...
- **Providers**: add Self-hosted STT / TTS / Embedding — point Dardcor Code at your own
...
- **RTK**: `X-Dardcor Code-Token-Saver` header to bypass token savers per request
...
## Docs
- README: add Indonesian Dardcor Code tutorial video (#1709)
