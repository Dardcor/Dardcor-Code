...
<!-- skill:custom-start -->
<!-- Migrated from skills/Dardcor Code-routing/SKILL.md (preserved curated content) -->

# Dardcor Code — Routing & Combos
...
```
Dardcor Code_list_combos     → list all combos
Dardcor Code_switch_combo    → enable/disable a combo
Dardcor Code_set_routing_strategy → change strategy at runtime
Dardcor Code_simulate_route  → dry-run routing decision
Dardcor Code_best_combo_for_task → get recommendation by task type
```
