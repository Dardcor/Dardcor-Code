...
description: "Interact with Dardcor Code via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities."
---
<!-- generated by src/lib/agentSkills/generator.ts; manual edits will be overwritten -->

## Overview

Interact with Dardcor Code via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities.
...
<!-- skill:custom-start -->
<!-- Migrated from skills/Dardcor Code-a2a/SKILL.md (preserved curated content) -->

# Dardcor Code — A2A Protocol
...
Dardcor Code publishes an Agent Card at `/.well-known/agent.json` and accepts
...
Full docs: https://github.com/diegosouzapw/Dardcor Code/blob/main/docs/frameworks/A2A-SERVER.md
<!-- skill:custom-end -->
