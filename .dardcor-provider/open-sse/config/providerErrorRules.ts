...
// upstream quota is per-account, and a single DardcorCode provider entry maps to
// one user account. Multiple DardcorCode connections under the same provider
