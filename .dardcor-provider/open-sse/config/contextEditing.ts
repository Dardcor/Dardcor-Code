 ...
 *
 * Unlike DardcorCode's local compression engines (which rewrite the request body
 ...
 * context-management-2025-06-27` header, which DardcorCode already emits on Claude
