...
// local `droid` CLI. DardcorCode already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through DardcorCode.
//
...
// back to stored CLI credentials only when omitted. DardcorCode does NOT read
