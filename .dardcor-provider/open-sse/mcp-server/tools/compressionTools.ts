/**
 * DardcorCode MCP Compression Tools — Manage and monitor prompt compression.
 *
 * Tools:
 *   1. dardcorCode_compression_status   — Get compression config, analytics, and cache stats
 *   2. dardcorCode_compression_configure — Update compression settings
...
export async function handleCompressionStatus(
  ...
  try {
    ...
    await logToolCall("dardcorCode_compression_status", args, result, duration, true);
...
export async function handleCompressionConfigure(
  ...
  try {
    ...
    const duration = Date.now() - start;
    await logToolCall("dardcorCode_compression_configure", args, result, duration, true);
...
export async function handleCcrStoreTool(
  ...
  await logToolCall("dardcorCode_ccr_store", auditInput, output, Date.now() - start, true);
  return output;
}
...
export async function handleCcrRetrieveTool(
  ...
  if ((!args.mode || args.mode === "full") && metadata.bytes > MAX_CCR_MCP_FULL_BYTES) {
    ...
    await logToolCall("dardcorCode_ccr_retrieve", args, output, Date.now() - start, true);
    return output;
  }
...
export async function handleCcrInspectTool(
  ...
  await logToolCall("dardcorCode_ccr_inspect", args, output, Date.now() - start, Boolean(metadata));
  return output;
}
...
export async function handleCcrListTool(
  ...
  await logToolCall("dardcorCode_ccr_list", args, output, Date.now() - start, true);
  return output;
}
...
export async function handleCcrDeleteTool(
  ...
  await logToolCall("dardcorCode_ccr_delete", args, output, Date.now() - start, true);
  return output;
}
...
export async function handleCcrStatsTool(
  ...
  await logToolCall("dardcorCode_ccr_stats", args, output, Date.now() - start, true);
  return output;
}
...
export async function handleRtkDiscover(
  ...
  await logToolCall("dardcorCode_rtk_discover", args, result, Date.now() - start, true);
  return result;
}
...
export async function handleRtkLearn(
  ...
  await logToolCall("dardcorCode_rtk_learn", args, result, Date.now() - start, true);
  return result;
}
...
export const compressionTools = {
  ...
  dardcorCode_ccr_inspect: {
    name: "dardcorCode_ccr_inspect",
  ...
  dardcorCode_ccr_list: {
    name: "dardcorCode_ccr_list",
  ...
  dardcorCode_ccr_delete: {
    name: "dardcorCode_ccr_delete",
  ...
  dardcorCode_ccr_stats: {
    name: "dardcorCode_ccr_stats",
    description:
  ...
  dardcorCode_rtk_discover: {
    name: "dardcorCode_rtk_discover",
    description:
  ...
  dardcorCode_rtk_learn: {
    name: "dardcorCode_rtk_learn",
    description:
