/**
 * DardcorCode MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. dardcorCode_pool_status   — Get pool stats for one or all providers
 *   2. dardcorCode_pool_sessions — List per-session details for a provider's pool
 *   3. dardcorCode_pool_reset    — Shut down and recreate a pool
 *   4. dardcorCode_pool_warm     — Warm up a pool to a target session count
 *   5. dardcorCode_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  dardcorCode_pool_status: {
    name: "dardcorCode_pool_status",
    description:
  ...
  dardcorCode_pool_sessions: {
    name: "dardcorCode_pool_sessions",
    description:
  ...
  dardcorCode_pool_reset: {
    name: "dardcorCode_pool_reset",
    description:
  ...
  dardcorCode_pool_warm: {
    name: "dardcorCode_pool_warm",
    description:
  ...
  dardcorCode_pool_health: {
    name: "dardcorCode_pool_health",
    description:
  ...
  dardcorCode_browser_pool_status: {
    name: "dardcorCode_browser_pool_status",
    description:
