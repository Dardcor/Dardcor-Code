/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced DardcorCode MCP tools.
 *
 ...
 *
 * Each tool wraps existing DardcorCode API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "dardcorCode_get_health",
  description:
    "Returns the current health status of DardcorCode including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 2: dardcorCode_list_combos ---
...
// --- Tool 3: dardcorCode_get_combo_metrics ---
...
> = {
  name: "dardcorCode_get_combo_metrics",
  description:
...
// --- Tool 4: dardcorCode_switch_combo ---
...
// --- Tool 4b: dardcorCode_create_combo ---
...
// --- Tool 5: dardcorCode_check_quota ---
...
// --- Tool 6: dardcorCode_route_request ---
...
> = {
  name: "dardcorCode_route_request",
  description:
    "Sends a chat completion request through DardcorCode's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 7: dardcorCode_cost_report ---
...
// --- Tool 8: dardcorCode_list_models_catalog ---
...
> = {
  name: "dardcorCode_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "dardcorCode_web_search",
  description:
    "Performs a web search using DardcorCode's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "dardcorCode_web_fetch",
  description:
    "Fetches and extracts content from a URL using DardcorCode's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: dardcorCode_simulate_route ---
...
> = {
  name: "dardcorCode_simulate_route",
  description:
...
// --- Tool 10: dardcorCode_set_budget_guard ---
...
> = {
  name: "dardcorCode_set_budget_guard",
  description:
...
// --- Tool 11: dardcorCode_set_routing_strategy ---
...
> = {
  name: "dardcorCode_set_routing_strategy",
  description:
...
// --- Tool 12: dardcorCode_set_resilience_profile ---
...
> = {
  name: "dardcorCode_set_resilience_profile",
  description:
...
// --- Tool 13: dardcorCode_test_combo ---
...
// --- Tool 14: dardcorCode_get_provider_metrics ---
...
> = {
  name: "dardcorCode_get_provider_metrics",
  description:
...
// --- Tool 15: dardcorCode_best_combo_for_task ---
...
> = {
  name: "dardcorCode_best_combo_for_task",
  description:
...
// --- Tool 16: dardcorCode_explain_route ---
...
> = {
  name: "dardcorCode_explain_route",
  description:
...
// --- Tool 17: dardcorCode_get_session_snapshot ---
...
> = {
  name: "dardcorCode_get_session_snapshot",
  description:
...
// --- Tool 18: dardcorCode_db_health_check ---
...
> = {
  name: "dardcorCode_db_health_check",
  description:
    "Diagnoses DardcorCode database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: dardcorCode_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "dardcorCode_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into DardcorCode. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "dardcorCode_compression_status",
  description:
...
> = {
  name: "dardcorCode_compression_configure",
  description:
...
> = {
  name: "dardcorCode_set_compression_engine",
...
> = {
  name: "dardcorCode_list_compression_combos",
...
> = {
  name: "dardcorCode_compression_combo_stats",
...
> = {
  name: "dardcorCode_oneproxy_fetch",
  description:
...
> = {
  name: "dardcorCode_oneproxy_rotate",
  description:
...
> = {
  name: "dardcorCode_oneproxy_stats",
  description:
...
> = {
  name: "dardcorCode_agent_skills_list",
  description:
    "List DardcorCode agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "dardcorCode_agent_skills_get",
  description:
...
// --- dardcorCode_agent_skills_coverage ---
...
> = {
  name: "dardcorCode_agent_skills_coverage",
  description:
