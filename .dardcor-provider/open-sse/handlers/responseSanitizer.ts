...
export const OMIT_STREAMING_CHUNK_MARKER = "__dardcorCode_omit_streaming_chunk";
...
export interface SanitizeOpenAIResponseOptions {
   ...
   * Wired to the `x-dardcorCode-strip-reasoning` request header for clients whose
