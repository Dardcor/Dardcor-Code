 ...
 */
import { buildErrorBody } from "@dardcorCode/open-sse/utils/error.ts";
import { getCircuitBreaker } from "@/shared/utils/circuitBreaker";
import { isModelLocked } from "@dardcorCode/open-sse/services/accountFallback.ts";
...
export async function getAutoComboCandidates(
  ...
  if (channel === "auto") {
    ...
    const { createBuiltinAutoCombo } =
      await import("@dardcorCode/open-sse/services/autoCombo/builtinCatalog.ts");
