 ...
 *
 *   1. The client (DardcorCode) generates an ephemeral RSA keypair.
 ...
 *   5. DardcorCode decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + DardcorCode conventions. `fetch` is intentionally the
