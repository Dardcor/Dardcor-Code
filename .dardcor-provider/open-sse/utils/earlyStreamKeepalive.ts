 ...
 *
 * @changes
 * - [2026-07-28] [Cursor Grok 4.5] - Scrub dardcorCode from client-facing keepalive id/model/comment frames
 * - [2026-07-28] [Cursor Grok 4.5] - Neutralize Responses startup thinking text (no DardcorCode brand leak)
 *
