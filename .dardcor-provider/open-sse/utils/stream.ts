...
import { buildDardcorCodeSseMetadataComment } from "@/domain/dardcorCodeResponseMeta";
import {
...
export const PENDING_REQUEST_CLEARED_MARKER = "__dardcorCodePendingRequestCleared";
            ...
            if (trimmed.startsWith("data:") && trimmed.slice(5).trim() !== "[DONE]") {
              try {
                ...
                if (isResponsesSSE) {
                  ...
                  // chunk like "[DardcorCode] Upstream returned an empty response. Please
