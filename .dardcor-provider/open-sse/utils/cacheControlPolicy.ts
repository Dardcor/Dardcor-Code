 ...
 * vs. applying DardcorCode's own caching strategy.
 *
 ...
 * strategies) forced DardcorCode to strip the client's markers and re-derive
 ...
 * @returns true if cache_control should be preserved, false if DardcorCode should manage it
 */
