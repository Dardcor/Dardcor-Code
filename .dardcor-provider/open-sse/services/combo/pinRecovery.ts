  ...
  switch (terminalReason) {
    ...
    case "max_attempts_exceeded":
      return {
        action: "try-auto",
        next_step:
          "Every candidate in this combo failed. Switch to model: auto to let DardcorCode pick a working provider, or pick a different combo.",
      };
    ...
    case "all_models_failed":
      return {
        action: "try-auto",
        next_step:
          "Every model in this combo failed. Switch to model: auto to let DardcorCode pick a working provider, or wait a few seconds for rate limits to recover.",
