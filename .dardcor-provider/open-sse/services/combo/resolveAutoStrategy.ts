...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-DardcorCode-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-DardcorCode-Budget value in USD (#6023). */
    budgetCap?: number | null;
    /** Per-request X-DardcorCode-Budget-Fallback value ("cheapest" | "strict") — #3470. */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025 / #3470): X-DardcorCode-Budget,
  // X-DardcorCode-Budget-Fallback and X-DardcorCode-Mode headers (threaded via
  ...
  // per-request X-DardcorCode-Mode override — but `scoreAutoTargets()` (the fallback
