 ...
 * (Anthropic's current model migration guidance). DardcorCode can still produce a manual
 ...
 * This contract is verified for DardcorCode's two direct Anthropic API providers:
