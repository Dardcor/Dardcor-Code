 ...
 * DardcorCode keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers DardcorCode emits across formats: OpenAI `data: [DONE]`,
