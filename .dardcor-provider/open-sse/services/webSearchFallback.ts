...
export const OMNIROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME = "dardcorCode_web_search";
...
// built-in web-search tool has to be converted to the dardcorCode_web_search function
...
export function supportsNativeWebSearchFallbackBypass({
  ...
  // native tool untouched instead of rewriting it to dardcorCode_web_search. Mirrors the
