 ...
 *
 * DardcorCode's account-fallback engine (accountFallback.ts) historically rotated accounts using
...
const GLOBAL_KEY = "__dardcorCode_rotation_config__";
...
const COUNTER_KEY = "__dardcorCode_rotation_counters__";
