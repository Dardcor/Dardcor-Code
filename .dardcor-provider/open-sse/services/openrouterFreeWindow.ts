 ...
 *
 * Bucketed by ACCOUNT, not by connection/key — multiple DardcorCode connections
 * that share one upstream OpenRouter account must share one window. DardcorCode's
