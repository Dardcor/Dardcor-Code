...
function responseHeaders(contentType: string, metadata: Record<string, string>): Headers {
  ...
  const headerNames: Record<string, string> = {
    operation: "X-DardcorCode-Claude-Web-Operation",
    conversation_id: "X-DardcorCode-Claude-Web-Conversation-Id",
    parent_message_uuid: "X-DardcorCode-Claude-Web-Parent-Message-Uuid",
    assistant_message_uuid: "X-DardcorCode-Claude-Web-Assistant-Message-Uuid",
  };
