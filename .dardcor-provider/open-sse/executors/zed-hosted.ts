 ...
 * to OpenAI Chat Completions chunks by reusing DardcorCode's own translators
 ...
 * adapted to TypeScript + DardcorCode's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      ...
      clientHeaders?.["x-dardcorCode-thinking-marker"] ??
      null,
    ...
    const response = await zedLlmFetch(zedCredentials, "/completions", {
      ...
      fetchOptions: {
        ...
        headers: {
          ...
          "User-Agent": `DardcorCode/zed-hosted`,
