 ...
 *
 * DardcorCode → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only DardcorCode-style backwards-compat aliases where users
...
// DardcorCode uses dot-notation user IDs (e.g. "gpt-5.5-high").
