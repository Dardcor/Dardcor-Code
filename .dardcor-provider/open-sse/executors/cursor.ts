...
// prior switch_mode exchange (AGENT_MODE_PRIMER). On DardcorCode's native-tool
    ...
    if (!http2) {
      return {
        response: buildErrorResponse(
          501,
          "Cursor provider requires Node.js http2, which is unavailable in this runtime (Edge / Cloudflare Workers / similar). Run DardcorCode on a Node.js runtime to use cursor.",
          "unsupported_runtime"
        ),
        url,
        headers,
