...
function sanitizeAntigravityGeminiRequest(
  ...
  // Missing settings stay absent so DardcorCode does not silently weaken upstream safety.
...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set DARDCOR_CODE_ALLOW_BODY_PROJECT_OVERRIDE=1.
