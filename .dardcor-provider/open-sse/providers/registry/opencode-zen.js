...
export default {
  ...
  display: {
    ...
    notice: {
      text: "OpenCode Zen 100% Free models: DeepSeek V4 Flash, Big Pickle, MiMo V2.5, HY3, Nemotron 3 Ultra, Nemotron 3.5 Lightning, Laguna S 2.1.",
