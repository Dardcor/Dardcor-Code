 ...
 *
 * Source of truth for which browser origins may call DardcorCode over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-dardcorCode-connection, x-internal-test, accept";
