...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-dardcorCode-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-dardcorCode-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-dardcorCode-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-dardcorCode-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-dardcorCode-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-dardcorCode-cli-token";
 ...
 */
export const PEER_IP_HEADER = "x-dardcorCode-peer-ip";
 ...
 * proxy hop (e.g. DardcorCode behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-dardcorCode-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-dardcorCode-peer-locality";
