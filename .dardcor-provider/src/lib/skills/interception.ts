...
import { OMNIROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@dardcorCode/open-sse/services/webSearchFallback.ts";
import { OMNIROUTE_WEB_FETCH_FALLBACK_TOOL_NAME } from "@dardcorCode/open-sse/services/webFetchInterception.ts";
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the DardcorCode-handled tool_use blocks, and expose
