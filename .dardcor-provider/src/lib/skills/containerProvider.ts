/**
 * Container runtime providers for the DardcorCode skill sandbox.
 *
 * The sandbox historically hardcoded the `docker` CLI. This module abstracts
 * the container runtime so DardcorCode can pick the most performant / native
...
const SANDBOX_NAME = (sandboxId: string) => `dardcorCode-${sandboxId}`;
