...
declare global {
  var __dardcorCodeCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__dardcorCodeCredentialCache) {
    globalThis.__dardcorCodeCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__dardcorCodeCredentialCache;
}
