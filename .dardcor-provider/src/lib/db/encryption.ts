 ...
 * The PRIMARY key is now derived with a static salt ("dardcorCode-field-encryption-v1").
 ...
 * a different derived key than the static salt `"dardcorCode-field-encryption-v1"`. When the
...
const PREFIX = "enc:v1:";
const STATIC_SALT = "dardcorCode-field-encryption-v1";
