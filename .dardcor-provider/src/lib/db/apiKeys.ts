...
import { resolveModelAlias } from "@dardcorCode/open-sse/services/modelDeprecation.ts";
...
/**
 * Select an API key for internal DardcorCode operations (combo health checks,
