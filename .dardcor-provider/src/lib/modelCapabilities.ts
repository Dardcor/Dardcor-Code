...
import { parseModel, resolveCanonicalProviderModel } from "@dardcorCode/open-sse/services/model.ts";
import {
...
import { getUnsupportedParams } from "@dardcorCode/open-sse/config/providerRegistry.ts";
import {
  getLearnedThinkingCap,
  GEMINI_FALLBACK_THINKING_CAP,
} from "@dardcorCode/open-sse/services/learnedThinkingCaps.ts";
...
function reverseModelsDevProviders(provider: string): readonly string[] {
  // models.dev may store capabilities under a different DardcorCode provider id
