 ...
 * supporter-plans (payment) page on the private radar.dardcorCode.online
 * server.
 *
...
const DEFAULT_CONTRIBUTOR_CLAIM_URL = "https://radar.dardcorCode.online/auth/github";

/** Default supporter plans/payment page. */
const DEFAULT_SUPPORTER_PLANS_URL = "https://radar.dardcorCode.online/planos";
