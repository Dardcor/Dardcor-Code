 ...
 *
 * Scans ~/.dardcorCode/plugins/ for subdirectories containing plugin.json manifests.
...
/**
 * Get the default plugin directory: ~/.dardcorCode/plugins/
 */
export function getDefaultPluginDir(): string {
  const home = process.env.HOME || process.env.USERPROFILE || "/tmp";
  return join(home, ".dardcorCode", "plugins");
}
