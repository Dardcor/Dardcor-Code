 ...
 *
 * These tokens authorize the `dardcorCode` CLI (and dashboard) to run *management*
 * commands against a (possibly remote) DardcorCode server. They are distinct from
