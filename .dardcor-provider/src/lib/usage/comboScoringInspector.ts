...
import {
  ...
  type ScoringWeights,
  validateWeights,
} from "@dardcorCode/open-sse/services/autoCombo/scoring.ts";
import { getModePack } from "@dardcorCode/open-sse/services/autoCombo/modePacks.ts";
import { getTaskFitness } from "@dardcorCode/open-sse/services/autoCombo/taskFitness.ts";
import type {
  ComboAutopilotCombo,
