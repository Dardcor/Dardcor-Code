...
function buildFactors(log: ExplainLog, targetStats: TargetStats): ExplanationFactor[] {
  ...
  factors.push({
    ...
    details: log.comboName
      ...
      : "No combo metadata was persisted, so DardcorCode treated this as direct routing.",
  });
  ...
  factors.push({
    ...
    details: "Shows whether DardcorCode cache or compression affected cost/latency for this route.",
  });
