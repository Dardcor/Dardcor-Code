...
} from "@dardcorCode/open-sse/config/providerHeaderProfiles.ts";
import {
  applyAntigravityClientProfileHeaders,
  getAntigravityClientProfile,
} from "@dardcorCode/open-sse/services/antigravityClientProfile.ts";
...
} from "@dardcorCode/open-sse/executors/antigravity.ts";
import { getCreditsMode } from "@dardcorCode/open-sse/services/antigravityCredits.ts";
import {
  generateAntigravityRequestId,
  getAntigravitySessionId,
} from "@dardcorCode/open-sse/services/antigravityIdentity.ts";
 ...
 * Real Claude OAuth quota windows are fetched in @dardcorCode/open-sse/services/usage.ts.
 */
