 ...
 * trace out of DardcorCode into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The DardcorCode capture source
...
const CREATOR_NAME = "DardcorCode Traffic Inspector";
