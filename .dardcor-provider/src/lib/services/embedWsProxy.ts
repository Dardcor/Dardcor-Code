 ...
 *     is set explicitly. The DardcorCode LOCAL_ONLY rule is enforced at the
...
declare global {
  var __dardcorCodeEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__dardcorCodeEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__dardcorCodeEmbedWsStarted = true;
