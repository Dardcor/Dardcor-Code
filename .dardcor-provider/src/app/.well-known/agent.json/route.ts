 ...
 *
 * Serves the DardcorCode A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the DardcorCode Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "DardcorCode AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 DardcorCode agent skills (22 API + 20 CLI) " +
