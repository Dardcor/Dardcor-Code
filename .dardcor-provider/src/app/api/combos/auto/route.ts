...
import {
  VALID_VARIANTS,
  type AutoVariant,
} from "@dardcorCode/open-sse/services/autoCombo/autoPrefix";
import {
  AUTO_SUFFIX_VARIANTS,
  AUTO_TEMPLATE_VARIANTS,
  AUTO_FAMILY_IDS,
} from "@dardcorCode/open-sse/services/autoCombo/builtinCatalog";
import { parseAutoSuffix } from "@dardcorCode/open-sse/services/autoCombo/suffixComposition";
...
export async function GET(request: Request) {
  ...
  try {
    const { createVirtualAutoCombo } =
      await import("@dardcorCode/open-sse/services/autoCombo/virtualFactory");
