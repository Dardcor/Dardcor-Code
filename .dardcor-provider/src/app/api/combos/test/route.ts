...
import { resolveNestedComboTargets } from "@dardcorCode/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // DardcorCode's semantic cache or other request reuse layers.
          "X-DardcorCode-No-Cache": "true",
          ...(target.connectionId ? { "X-DardcorCode-Connection": target.connectionId } : {}),
