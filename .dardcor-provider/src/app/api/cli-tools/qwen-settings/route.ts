...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      ...runtime,
      settings,
      hasDardcorCode: hasDardcorCodeQwenCodeConfig(settings),
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    ...
    if (!apiKey) apiKey = "sk_dardcorCode";
    ...
    return NextResponse.json({
      success: true,
      message: "Qwen Code now routes through DardcorCode",
      settingsPath: configPaths.settings,
      envPath: configPaths.env,
    });
  } catch (error) {
...
export async function DELETE(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "DardcorCode settings removed from Qwen Code",
    });
  } catch (error) {
