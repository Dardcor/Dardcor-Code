...
// Check if DardcorCode is configured as OpenAI-compatible provider
const hasDardcorCodeConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasDardcorCode: hasDardcorCodeConfig(globalState),
...
// POST - Configure Cline to use DardcorCode as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_dardcorCode";
...
// DELETE - Remove DardcorCode OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "DardcorCode settings removed from Cline",
    });
  } catch (error) {
