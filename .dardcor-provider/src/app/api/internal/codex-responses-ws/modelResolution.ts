 ...
 * DardcorCode's global model routing, which the bridge would then reject with
 ...
 * model IDs like "gpt-5.5" to /v1/responses. Without this resolution, DardcorCode
...
export async function resolveResponsesApiModel(
  ...
  // #3509: "auto" is DardcorCode's zero-config auto-routing keyword (handled by the
