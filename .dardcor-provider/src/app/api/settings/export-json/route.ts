 ...
 * Exports a legacy DardcorCode-compatible JSON backup.
 */
  ...
  try {
    ...
    const exportData: Record<string, unknown> = {
      ...
      _meta: {
        ...
        version: "dardcorCode-v3-legacy-export",
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="dardcorCode-legacy-backup-${new Date().toISOString().replace(/[:.]/g, "-")}.json"`,
      },
    });
  } catch (error) {
