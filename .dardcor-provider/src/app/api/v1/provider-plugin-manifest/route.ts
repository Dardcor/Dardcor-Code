...
import { generateProviderPluginManifest } from "@dardcorCode/open-sse/config/providerPluginManifestRegistry.ts";
...
import type {
  ...
  ProviderPluginModel,
} from "@dardcorCode/open-sse/config/providerPluginManifest.ts";
