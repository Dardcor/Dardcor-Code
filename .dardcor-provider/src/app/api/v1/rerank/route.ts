import { handleRerank } from "@dardcorCode/open-sse/handlers/rerank.ts";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import { parseRerankModel, getRerankProvider } from "@dardcorCode/open-sse/config/rerankRegistry.ts";
