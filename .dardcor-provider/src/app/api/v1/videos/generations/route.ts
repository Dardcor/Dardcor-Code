import { handleVideoGeneration } from "@dardcorCode/open-sse/handlers/videoGeneration.ts";
import { resolveVideoCredentialProvider } from "@dardcorCode/open-sse/handlers/videoGeneration/googleFlow.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { parseVideoModel, getVideoProvider } from "@dardcorCode/open-sse/config/videoRegistry.ts";
