/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. DardcorCode routes
 ...
 * the model they asked for, and the `x-dardcorCode-model` response header
 ...
 * requested identifier (matching the `x-dardcorCode-model` response header).
 */
