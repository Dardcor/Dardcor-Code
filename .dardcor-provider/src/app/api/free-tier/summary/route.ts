import { computeFreeModelTotals } from "@dardcorCode/open-sse/config/freeModelCatalog.ts";
import { FREE_CATALOG_CURATED_AT } from "@dardcorCode/open-sse/config/freeModelCatalog.data.ts";
