 ...
 * Uses DardcorCode's skill registry + CLI tool paths (no Skill Collector bridge).
 *
 * Body: {
...
import { sanitizeErrorMessage, buildErrorBody } from "@dardcorCode/open-sse/utils/error";
