...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@dardcorCode/open-sse/services/rateLimitManager"),
      import("@dardcorCode/open-sse/services/accountFallback"),
      import("@dardcorCode/open-sse/services/requestDedup.ts"),
      import("@dardcorCode/open-sse/services/quotaMonitor.ts"),
      import("@dardcorCode/open-sse/services/sessionManager.ts"),
      import("@/lib/credentialHealth/cache"),
      import("@/lib/localHealthCheck"),
      import("@dardcorCode/open-sse/services/admission/runtime.ts"),
      getCachedSettings(),
