 ...
 * - Web/CLI: CLI reset via dardcorCode-reset-password command + manual database reset
              ...
              <div className="flex items-start gap-4 p-2">
                ...
                <div className="flex-1">
                  ...
                  <ol className="text-sm text-text-muted space-y-2 list-decimal list-inside mb-3">
                    <li>Quit the DardcorCode desktop app completely</li>
                    <li>
                    ...
                    <li>Relaunch the DardcorCode desktop app — it will start fresh setup</li>
                  </ol>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start gap-4 p-2">
                ...
                <div className="flex-1">
                  ...
                  <ol className="text-sm text-text-muted space-y-2 list-decimal list-inside mb-3">
                    ...
                    <li>Relaunch the DardcorCode desktop app</li>
                  </ol>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start gap-4 p-2">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-black/30 rounded-lg p-3 mb-3 font-mono text-sm text-green-400 border border-white/5">
                    <code>npx dardcorCode reset-password</code>
                  </div>
