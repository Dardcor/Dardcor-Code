...
/**
 * Shown when DardcorCode was started with auto-generated secrets (zero-config mode).
...
export default function BootstrapBanner() {
  ...
  const dataDir =
    typeof navigator !== "undefined" && navigator.platform?.startsWith("Win")
      ? "%APPDATA%\\dardcorCode\\server.env"
      : "~/.dardcorCode/server.env";
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-amber-800/80 dark:text-amber-200/80">
          DardcorCode auto-generated secure encryption keys on first launch. They are persisted to{" "}
