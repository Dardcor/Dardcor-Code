      ...
      if (data?.needsLogin && data?.authUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Complete the Tailscale login in the opened browser tab. DardcorCode will retry automatically."
          ),
        });
      ...
      if (data?.funnelNotEnabled && data?.enableUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Enable Funnel for this device in the opened browser tab. DardcorCode will keep polling."
          ),
        });
      ...
      <Card>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-3 py-3">
            ...
            <div className="flex-1 min-w-0">
              <span className="text-sm font-medium">{t("cloudDardcorCode")}</span>
            </div>
            <span
          ...
          <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
            <p className="text-sm font-medium text-blue-300">
              {translateOrFallback(
                ...
                "Installs Tailscale on this machine and prepares DardcorCode to enable Funnel."
              )}
            </p>
