...
const KIMI_CODING_AFF_URL = "https://www.kimi.com/code?aff=dardcorCode";
...
const DISMISS_STORAGE_KEY = "dardcorCode-kimi-sponsor-banner-dismissed-v1";
// Same-tab signal for the dismiss button, since writing localStorage doesn't
// fire a "storage" event in the tab that wrote it.
const DISMISS_EVENT = "dardcorCode:kimi-sponsor-banner-dismissed";
...
/**
 * Dismissable banner announcing the Kimi (Moonshot AI) official DardcorCode
