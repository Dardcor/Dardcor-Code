...
const LS_PURCHASE_FILTER = "dardcorCode:limits:purchaseFilter";
const LS_STATUS_FILTER = "dardcorCode:limits:statusFilter";
const LS_ENV_FILTER = "dardcorCode:limits:envFilter";
const LS_PROVIDER_FILTER = "dardcorCode:limits:providerFilter";
