...
export default function ProfilePage() {
    ...
    fetch("/api/settings")
      ...
      .then((data) => {
        ...
        setSamlForm({
          ...
          samlIssuer: data?.samlIssuer || "urn:dardcor-code:sp",
    ...
    reader.onload = (e) => {
      try {
        ...
        setSamlForm((prev) => ({
          ...
          samlIssuer: prev.samlIssuer || "urn:dardcor-code:sp",
  ...
  const saveSamlSettings = async (targetAuthMode = oidcForm.authMode || "password") => {
    ...
    try {
      const payload = {
        ...
        samlIssuer: samlForm.samlIssuer.trim() || "urn:dardcor-code:sp",
  ...
  const handleExportDatabase = async (password) => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `dardcor-code-backup-${stamp}.json`;
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.dardcor-code/db/data.sqlite</p>
              </div>
            </div>
                ...
                <div className="flex flex-col gap-4 pt-2 border-t border-border/50">
                        ...
                        <div className="p-2.5 rounded border border-primary/20 bg-primary/5 text-primary text-xs">
                          ...
                          <ul className="list-disc pl-4 space-y-1 font-mono text-[11px]">
                            ...
                            <li>
                              ...
                              <code className="bg-bg px-1 py-0.5 rounded break-all">{samlForm.samlIssuer || "urn:dardcor-code:sp"}</code>
                            </li>
                            <li>
                              <b>NameID Format:</b>{" "}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li>Set <b>Application SAML audience</b> to <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:dardcor-code:sp"}</code>.</li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Identifier (Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:dardcor-code:sp"}</code></li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Audience URI (SP Entity ID):</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:dardcor-code:sp"}</code></li>
                          ...
                          <div className="p-3 rounded border border-border bg-bg/50 flex flex-col gap-1.5">
                            ...
                            <ol className="list-decimal pl-4 text-text-muted space-y-1">
                              ...
                              <li><b>Client ID:</b> <code className="text-text-main font-mono">{samlForm.samlIssuer || "urn:dardcor-code:sp"}</code></li>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        placeholder="urn:dardcor-code:sp"
                  ...
                  <div className="flex flex-col gap-2 p-3 rounded-lg border border-border bg-bg text-xs sm:text-sm text-text-muted">
                    ...
                    <div className="flex items-center justify-between gap-2 pt-2 border-t border-border/50">
                      ...
                      <a
                        ...
                        download="dardcor-code-sp-metadata.xml"
                ...
                <div className="flex flex-col gap-4 pt-2 border-t border-border/50">
                  <div className="grid grid-cols-1 gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        placeholder="https://auth.example.com/application/o/dardcor-code/"
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        placeholder="dardcor-code-dashboard"
