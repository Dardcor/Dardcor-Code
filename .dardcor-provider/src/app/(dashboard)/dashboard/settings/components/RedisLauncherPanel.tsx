 ...
 * shells out to the same logic exposed via the `dardcorCode redis` CLI command.
  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-5">
      ...
      <p className="mt-3 text-xs text-text-muted">
        {t(
          "redisLauncherHint",
          "Equivalent to running `dardcorCode redis up`. The container is named `dardcorCode-redis` and listens on 127.0.0.1:6379."
        )}
      </p>
    </div>
  );
