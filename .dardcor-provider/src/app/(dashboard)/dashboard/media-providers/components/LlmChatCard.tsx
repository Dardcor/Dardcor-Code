 ...
 * DardcorCode can resolve it unambiguously. The previous heuristic only prefixed
...
export function LlmChatCard({
  ...
  // Auto-prefix model with the provider's routing alias to avoid DardcorCode "Ambiguous model"
