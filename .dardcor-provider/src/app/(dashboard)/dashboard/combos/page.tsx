...
const COMBO_USAGE_GUIDE_STORAGE_KEY = "dardcorCode:combos:hide-usage-guide";
                      ...
                      <div>
                        <FieldLabelWithHelp
                          ...
                          help={getI18nOrFallback(
                            ...
                            "When quota usage reaches this threshold, DardcorCode generates a structured handoff summary before the account is exhausted."
                          )}
                          showHelp={!isExpertMode}
                        />
                        <input
