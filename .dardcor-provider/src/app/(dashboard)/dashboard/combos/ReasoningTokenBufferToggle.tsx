    ...
    <div className="flex items-center gap-2 py-1">
      ...
      <Tooltip
        ...
        content={getI18nOrFallback(
          ...
          "When enabled (default), DardcorCode may increase max_tokens for reasoning-capable models so they have headroom to think. Turn this off if you need this combo to preserve the client's exact max_tokens."
        )}
      >
