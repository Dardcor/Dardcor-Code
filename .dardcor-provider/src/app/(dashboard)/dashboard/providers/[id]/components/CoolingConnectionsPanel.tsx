 ...
 * indicator the user has no way to see "DardcorCode learned that this key is
  ...
  return (
    ...
    >
      ...
      <p className="mb-3 text-xs text-muted-foreground">
        These connections returned a 429 (rate-limit) on their last request. DardcorCode will skip
