export const SHOW_CONFIGURED_ONLY_STORAGE_KEY = "dardcorCode-providers-show-configured-only";
export const PROVIDER_DISPLAY_MODE_STORAGE_KEY = "dardcorCode-providers-display-mode";
