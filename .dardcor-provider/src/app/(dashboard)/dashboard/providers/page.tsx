            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-text-muted mt-2 max-w-md">
                {t("addFirstProviderDesc") ||
                  "Connect an AI provider to start routing requests through DardcorCode. You can use free providers, API keys, or OAuth accounts."}
              </p>
              <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
                ...
                <a
                  href="https://github.com/diegosouzapw/DardcorCode#-documentation"
                  target="_blank"
