 ...
 * When enabled, CLIProxyAPI models appear as `cliproxyapi/...` in DardcorCode's model selection.
 */
"use client";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-text-muted mt-0.5">
            When enabled, discovered models appear in provider selects across DardcorCode.
          </p>
        </div>
