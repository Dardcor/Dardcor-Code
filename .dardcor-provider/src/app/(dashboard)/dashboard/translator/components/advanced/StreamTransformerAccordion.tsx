...
data: {"id":"chatcmpl_demo","object":"chat.completion.chunk","created":1745366400,"model":"gpt-4o-mini","choices":[{"index":0,"delta":{"content":" from DardcorCode"},"finish_reason":null}]}
              ...
              <div>
                ...
                <p>
                  {translateOrFallback(
                    ...
                    "Paste a chat completions SSE stream, run it through DardcorCode's Responses transformer, and inspect the emitted response.* events before wiring a client."
                  )}
                </p>
              </div>
            </div>
