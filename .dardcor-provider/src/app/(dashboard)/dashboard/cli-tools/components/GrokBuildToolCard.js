          ...
          {!checking && grokStatus?.installed && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={handleReset} disabled={!grokStatus?.hasDardcorCode} loading={restoring} className="w-full sm:w-auto"><span className="material-symbols-outlined text-[14px] mr-1">restore</span>Reset</Button>
