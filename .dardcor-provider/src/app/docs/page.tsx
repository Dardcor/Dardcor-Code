...
export const metadata: Metadata = {
  title: "DardcorCode Documentation",
  description:
    "Everything you need to route, compress, and scale your AI — setup guides, API reference, compression, deployment, and more.",
  openGraph: {
    title: "DardcorCode Documentation",
    description:
      "Comprehensive docs for DardcorCode AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://dardcorCode.online/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "DardcorCode Documentation",
    description: "Comprehensive docs for DardcorCode AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get DardcorCode running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let DardcorCode pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">DardcorCode Documentation</h1>
