  ...
  return (
    <section className="py-24 border-y border-[#3a2f27] bg-[#23180f]/30" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">How Dardcor Code Works</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2 text-[#f97815]">2. Dardcor Code Hub</h3>
              <p className="text-sm text-gray-400">
