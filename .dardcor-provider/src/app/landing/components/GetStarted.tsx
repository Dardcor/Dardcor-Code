          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4 min-w-0">
                ...
                <div>
                  <h4 className="font-bold text-lg">{t("installDardcorCode")}</h4>
            ...
            <div className="rounded-xl overflow-hidden bg-[#161B22] border border-[#2D333B] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-hidden">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#E54D5E]">&gt;</span> {t("startingDardcorCode")}
                  <br />
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="break-all">~/.dardcorCode/db.json</span>
                  <br />
                  <span className="text-gray-500">{t("dataLocationWindows")}</span>{" "}
                  <span className="break-all">%APPDATA%/dardcorCode/db.json</span>
                </div>
              </div>
            </div>
          </div>
