...
const INSTRUCTIONS = [
  "1. Install DardcorCode's root certificate",
  "2. Start the MITM proxy via Dashboard or CLI",
  "3. Configure model mappings in Dashboard → AgentBridge → Antigravity",
  "4. Open Antigravity IDE — API calls will be routed through DardcorCode",
];
...
export const ANTIGRAVITY_MITM_PROFILE: MitmTarget & {
  ...
  ...ANTIGRAVITY_TARGET,
  description:
    "Intercepts Antigravity IDE requests to cloudcode-pa.googleapis.com and routes them through DardcorCode.",
  targetHost: HOSTS[0],
  targetPort: 443,
  localPort: 443,
