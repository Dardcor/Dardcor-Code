...
/**
 * Resolve the deploy basePath for display URLs (e.g. `/dardcorCode`).
 *
 * Priority:
...
export function resolveDisplayBaseUrl(
  ...
  // Example: NEXT_PUBLIC_BASE_URL=https://host/dardcorCode must not be collapsed to
 ...
 * `src/shared/utils/resolveDardcorCodeBaseUrl.ts` instead.
 */
