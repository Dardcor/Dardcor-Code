...
export const COMPRESSION_CONTEXT_GROUP: SidebarItemGroup = {
  ...
  items: [
    ...
    {
      id: "context-dardcorglyph",
      href: "/dashboard/context/dardcorglyph",
      i18nKey: "contextOmniglyph",
      labelFallback: "DardcorGlyph",
...
const AGENTIC_FEATURES_ITEMS: readonly SidebarSectionChild[] = [
  ...
  {
    id: "skills",
    href: "/dashboard/dardcor-skills",
    i18nKey: "dardcorSkills",
    subtitleKey: "dardcorSkillsSubtitle",
    icon: "auto_fix_high",
  },
  MCP_ITEM,
  {
...
const HELP_ITEMS: readonly SidebarItemDefinition[] = [
  ...
  {
    id: "issues",
    href: "https://github.com/diegosouzapw/DardcorCode/issues",
    i18nKey: "issues",
...
export const SIDEBAR_SECTIONS: readonly SidebarSectionDefinition[] = [
  ...
  {
    id: "dardcor-proxy",
    titleKey: "dardcorProxySection",
    titleFallback: "DardcorProxy",
    children: [
      ...OMNI_PROXY_ITEMS,
