...
export const FEATURE_FLAG_DEFINITIONS: FeatureFlagDefinition[] = [
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeControlPlaneProxyDirectFallbackDescription",
    category: "network",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeAllowPrivateProviderUrlsDescription",
    category: "network",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    description:
      "Allow adding and validating providers on local/private addresses (127.0.0.1, localhost, LAN, private IP ranges) — needed for local OpenAI-compatible models. Enabled by default (DardcorCode is local-first); turn it OFF to enforce strict public-only blocking if you only use public providers. Cloud-metadata endpoints (e.g. 169.254.169.254) stay blocked either way.",
    descriptionI18nKey: "featureFlagDardcorCodeAllowLocalProviderUrlsDescription",
    category: "network",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    label: "Radar",
    description:
      "Enable the DardcorCode Radar module (catalog feed screens and sync). Off by default; enabling only unlocks the UI — data sync remains a separate opt-in.",
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeMcpEnforceScopesDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeMcpCompressDescriptionsDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeEnableRuntimeBackgroundTasksDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeDisableBackgroundServicesDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: true,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagdardcorCodeRtkTrustProjectFiltersDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeEnableLiveWsDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: true,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeCodexWsEnabledDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeEmergencyFallbackDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeAutoSyncCodexProfilesDescription",
    category: "cli",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeAutoSyncClaudeProfilesDescription",
    category: "cli",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  // ──────────────── Health (3) ────────────────
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeDisableLocalHealthcheckDescription",
    category: "health",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  },
  {
    ...
    descriptionI18nKey: "featureFlagDardcorCodeDisableTokenHealthcheckDescription",
    category: "health",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
