...
export const OAUTH_PROVIDERS = {
  ...
  "zed-hosted": {
    ...
    riskNoticeVariant: "oauth",
    authHint:
      "Sign in with your Zed account (native-app sign-in). DardcorCode generates a one-time RSA keypair and opens zed.dev to authorize it — on a remote/headless install, copy the resulting 127.0.0.1 callback URL from your browser's address bar and paste it back here. Distinct from the 'Zed IDE' credential-import entry above: this proxies chat completions through Zed's own hosted model aggregator (cloud.zed.dev), fronting Anthropic/OpenAI/Google/xAI models under your Zed plan.",
  },
  trae: {
    id: "trae",
    alias: "tr",
  ...
  "kimi-coding": {
    ...
    riskNoticeVariant: "oauth",
    authHint:
      "Sign in with the same Kimi account used by Kimi Code CLI. DardcorCode uses the CLI OAuth flow and Kimi Coding Plan endpoints.",
  },
  kilocode: {
    id: "kilocode",
    alias: "kc",
