...
export const WEB_COOKIE_PROVIDERS = {
  ...
  lmarena: {
    ...
    authHint:
      "Paste the full Cookie header from arena.ai (DevTools → Network → request → Cookie). Include arena-auth-prod-v1.0/.1… and cf_clearance/__cf_bm when present. DardcorCode uses Chrome TLS impersonation; if Arena still 403s, set providerSpecificData.recaptchaV3Token from a live browser session.",
    riskNoticeVariant: "webCookie",
  },
  "yuanbao-web": {
    id: "yuanbao-web",
  ...
  "kimi-web": {
    ...
    website: "https://www.kimi.com/code?aff=dardcorCode",
    authHint:
