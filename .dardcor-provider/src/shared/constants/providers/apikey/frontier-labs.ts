...
export const APIKEY_PROVIDERS_FRONTIER = {
  ...
  reka: {
    ...
    authHint:
      "Use your Reka API key. DardcorCode supports the OpenAI-compatible base URL https://api.reka.ai/v1 and sends both Authorization and X-Api-Key headers for compatibility.",
    apiHint:
      "Reka Chat is OpenAI-compatible on /v1. DardcorCode probes /v1/models and routes chat traffic to /v1/chat/completions.",
    hasFree: true,
  ...
  "nous-research": {
    ...
    authHint:
      "Use your Nous Portal API key. DardcorCode targets the official OpenAI-compatible inference endpoint at https://inference-api.nousresearch.com/v1.",
    apiHint:
