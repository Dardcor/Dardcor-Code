...
export const APIKEY_PROVIDERS_REGIONAL = {
  ...
  kimi: {
    ...
    website: "https://platform.kimi.ai?aff=dardcorCode",
  ...
  "clova-studio": {
    ...
    apiHint:
      "CLOVA Studio (HyperCLOVA X) is OpenAI-compatible on /v1/openai. DardcorCode probes /v1/openai/models and routes chat traffic to /v1/openai/chat/completions. Uses the current clovastudio.stream.ntruss.com host — the legacy clovastudio.apigw.ntruss.com endpoint is being deprecated.",
  },
  internlm: {
    id: "internlm",
    alias: "internlm",
  ...
  "ant-ling": {
    ...
    authHint:
      "Register and create an API key at the Ant Ling API console (https://chat.ant-ling.com/open), then paste it here. DardcorCode routes chat traffic to https://api.ant-ling.com/v1/chat/completions; the provider is OpenAI-compatible and also exposes an Anthropic-compatible surface.",
  },
  sarvam: {
    id: "sarvam",
    alias: "sarvam",
    ...
    apiHint:
      "Sarvam AI is OpenAI-compatible on /v1. DardcorCode probes /v1/models and routes chat traffic to /v1/chat/completions. Models are tuned for Indic languages.",
    hasFree: true,
