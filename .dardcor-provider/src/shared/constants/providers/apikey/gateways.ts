...
export const APIKEY_PROVIDERS_GATEWAYS = {
  ...
  cheaperinference: {
    ...
    color: "#31f889",
    textIcon: "CI",
    website: "https://cheaperinference.com/?utm_source=dardcorCode",
    apiHint:
      "Create an API key at https://cheaperinference.com/?utm_source=dardcorCode (needs the `inference` scope), then paste the ir_live_… token here.",
  ...
  zenmux: {
    ...
    apiHint:
      "ZenMux exposes an OpenAI-compatible chat completions endpoint at /api/v1/chat/completions, plus Anthropic Messages (/api/anthropic/v1/messages) and Google Gemini (/api/vertex-ai) protocol surfaces. DardcorCode uses the OpenAI protocol.",
  },
  openadapter: {
    id: "openadapter",
    alias: "oad",
    ...
    apiHint:
      "OpenAdapter exposes an OpenAI-compatible chat completions endpoint at https://api.openadapter.in/v1/chat/completions, aggregating 70+ open-source models (DeepSeek, Qwen, Kimi, MiniMax, GLM, Llama, Mistral, …). DardcorCode uses the OpenAI protocol.",
  },
  dit: {
    id: "dit",
    alias: "dai",
    ...
    apiHint:
      "dit.ai (Distributed Intelligence Trade) is an OpenAI-compatible router/gateway with dynamic per-request pricing, exposing /v1/chat/completions at https://api.dit.ai/v1. DardcorCode uses the OpenAI protocol; spend/savings analytics live in the dit.ai dashboard.",
  },
  tokenrouter: {
    id: "tokenrouter",
    alias: "trk",
    ...
    apiHint:
      "TokenRouter exposes an OpenAI-compatible chat completions endpoint at https://api.tokenrouter.com/v1/chat/completions, plus a working /v1/models catalog. DardcorCode uses the OpenAI protocol.",
  },
  sumopod: {
    id: "sumopod",
    alias: "sumopod",
    ...
    apiHint:
      "SumoPod exposes an OpenAI-compatible chat completions endpoint at https://ai.sumopod.com/v1/chat/completions, plus a live /v1/models catalog. DardcorCode uses the OpenAI protocol and lists models via passthrough.",
  },
  x5lab: {
    id: "x5lab",
    alias: "x5lab",
    ...
    apiHint:
      "X5Lab exposes an OpenAI-compatible chat completions endpoint at https://api.x5lab.dev/v1/chat/completions, plus a live /v1/models catalog. DardcorCode uses the OpenAI protocol and lists models via passthrough.",
  },
  chenzk: {
    id: "chenzk",
    alias: "chenzk",
  ...
  kenari: {
    ...
    apiHint:
      "Kenari exposes an OpenAI-compatible chat completions endpoint at https://kenari.id/v1/chat/completions, plus a live /v1/models catalog covering Claude, GPT, DeepSeek, GLM, Kimi and more. DardcorCode uses the OpenAI protocol and lists models via passthrough.",
  },
  navy: {
    id: "navy",
    alias: "navy",
  ...
  ainative: {
    ...
    apiHint:
      "OpenAI-compatible endpoint at https://api.ainative.studio/api/v1 with a public /models catalog (84 models). DardcorCode lists models via passthrough.",
  },
  aion: {
    id: "aion",
    alias: "aion",
