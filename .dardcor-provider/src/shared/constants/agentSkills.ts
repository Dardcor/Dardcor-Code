...
const REPO = "diegosouzapw/DardcorCode";
const BRANCH = "main";
...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
...

  {
    ...
    name: "Authentication",
    description:
      "Manage API key authentication and session tokens. Start here to authenticate requests via Bearer token, obtain session cookies, and configure login requirements for the DardcorCode API.",
    category: "api",
    area: "auth",
    icon: "lock",
    isEntry: true,
  ...
  },
  {
    ...
    name: "API Keys",
    description:
      "Create, list, rotate, and revoke DardcorCode API keys. Control per-key scopes, spending limits, and expiration. Keys gate access to all proxy and management endpoints.",
    category: "api",
    area: "api-keys",
    icon: "vpn_key",
  },
  ...
  },
  {
    ...
    name: "CLI Tools",
    description:
      "Manage CLI tool integrations exposed via the API. List, configure, and invoke CLI tool plugins that extend DardcorCode's automation surface.",
    category: "api",
    area: "cli-tools",
    icon: "terminal",
  },
  {
    ...
    name: "Tunnels",
    description:
      "Create and manage secure tunnels (ngrok, Cloudflare Tunnel, custom) to expose DardcorCode to the internet or share access with remote agents and CI pipelines.",
    category: "api",
    area: "tunnels",
    icon: "vpn_lock",
  },
  {
    ...
    name: "Cloud Sync",
    description:
      "Synchronise DardcorCode configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.",
    category: "api",
    area: "sync-cloud",
    icon: "cloud_sync",
  },
  ...
  },
  {
    ...
    name: "MCP Server",
    description:
      "Connect to the DardcorCode MCP server (37 tools, 3 transports: SSE/stdio/HTTP). Covers routing, cache, compression, memory, skills, providers, and audit tools across 16 permission scopes.",
    category: "api",
    area: "mcp",
  ...
  },
  {
    ...
    description:
      "Interact with DardcorCode via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities.",
    category: "api",
    area: "agents-a2a",
    icon: "device_hub",
  },
...

  {
    ...
    name: "CLI: Serve",
    description:
      "Start, stop, and restart the DardcorCode server from the CLI. Manage daemon mode, port configuration, auto-recovery, system tray integration, and the dashboard open shortcut.",
    category: "cli",
    area: "cli-serve",
    icon: "play_circle",
    isEntry: true,
  ...
  },
  {
    ...
    name: "CLI: API Keys",
    description:
      "Create, list, rotate, and revoke DardcorCode API keys from the CLI. Manage OAuth flows for provider authentication and inspect key scopes and expiration.",
    category: "cli",
    area: "cli-keys",
    icon: "vpn_key",
  },
  ...
  },
  {
    ...
    name: "CLI: Chat",
    description:
      "Send chat completions, stream responses, and start an interactive REPL session from the CLI. Supports all DardcorCode providers, combo routing, and system prompt configuration.",
    category: "cli",
    area: "cli-chat",
    icon: "chat",
  },
  ...
  },
  {
    ...
    description:
      "Interact with the DardcorCode A2A server from the CLI. Send tasks, inspect skill execution history, and test the JSON-RPC 2.0 agent-to-agent protocol interactively.",
    category: "cli",
    area: "cli-a2a",
    icon: "device_hub",
  },
  ...
  },
  {
    ...
    description:
      "Backup and restore DardcorCode data from the CLI. Trigger incremental snapshots, sync to cloud storage, manage backup schedules, and restore from archive files.",
    category: "cli",
  ...
  },
  {
    ...
    description:
      "Detect installed CLI coding tools (Claude Code, Codex, Cursor, Copilot, Cline and more), search GitHub for matching agent skills, and install them to the detected tools via DardcorCode's built-in APIs.",
    category: "cli",
    area: "cli-setup",
    icon: "extension",
  },
...

  {
    ...
    description:
      "Step-by-step agent workflow to configure the OpenAI Codex CLI on any machine (Linux, macOS, Windows) to use DardcorCode as an OpenAI-compatible backend. Detects OS and shell, writes config.toml and 7 named profiles, sets environment variables, and verifies the setup.",
    category: "config",
