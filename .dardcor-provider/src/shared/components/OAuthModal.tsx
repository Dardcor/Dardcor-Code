  ...
  const startOAuthFlow = useCallback(
    async (opts?: { grokBrowser?: boolean }) => {
      ...
      try {
        ...
        // show an auth code instead of redirecting back to DardcorCode.
        ...
        // 127.0.0.1:<port> callback that DardcorCode never listens on (the port is
        ...
        if (provider === "codex" || provider === "openai") {
          ...
          // Remote fallback: use DardcorCode's port with the /auth/callback path Windsurf expects.
          ...
          // Behind reverse proxy: use actual origin (e.g., https://dardcorCode.example.com/callback)
