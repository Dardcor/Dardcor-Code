...
const footerLinks = {
  product: [
    ...
    {
      label: "Changelog",
      href: "https://github.com/diegosouzapw/DardcorCode/releases",
      external: true,
    },
  ],
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/diegosouzapw/DardcorCode/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/diegosouzapw/DardcorCode", external: true },
    { label: "Blog", href: "https://github.com/diegosouzapw/DardcorCode/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/diegosouzapw/DardcorCode/issues/new/choose",
      external: true,
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/diegosouzapw/DardcorCode"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
                aria-label="GitHub"
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-text-muted">
            ...
            <a
              href="https://github.com/diegosouzapw/DardcorCode/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
