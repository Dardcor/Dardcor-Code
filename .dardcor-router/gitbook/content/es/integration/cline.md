...
Integra Dardcor Code con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de Dardcor Code.
...
Establece la URL base a tu endpoint de Dardcor Code:
...
**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de Dardcor Code
...
3. La key debe comenzar con `sk-dardcor-code-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de Dardcor Code
...
4. Cline usará Dardcor Code para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando Dardcor Code
...
3. Obtén explicaciones potenciadas por IA a través de Dardcor Code

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará Dardcor Code para entender el contexto y hacer cambios
...
2. Verifica que tu instancia de Dardcor Code esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de Dardcor Code para cualquier error
...
## Integración con características de Dardcor Code

### Enrutamiento de modelos

Dardcor Code enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, Dardcor Code automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de Dardcor Code:
