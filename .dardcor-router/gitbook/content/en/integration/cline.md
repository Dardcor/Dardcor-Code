...
Integrate Dardcor Code with Cline VSCode extension to route your AI requests through Dardcor Code's intelligent routing system.
...
Set the base URL to your Dardcor Code endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your Dardcor Code endpoint
...
3. The key should start with `sk-dardcor-code-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your Dardcor Code configuration
...
4. Cline will use Dardcor Code to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using Dardcor Code
...
3. Get AI-powered explanations through Dardcor Code

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use Dardcor Code to understand context and make changes
...
2. Verify your Dardcor Code instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check Dardcor Code logs for any errors
...
1. In Cline settings, set Base URL to: `https://dardcor-code.web.id`
2. Make sure you have configured your API key in the Dardcor Code cloud dashboard
...
## Integration with Dardcor Code Features

### Model Routing

Dardcor Code automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, Dardcor Code automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through Dardcor Code dashboard:
- Total requests
- Token usage
- Cost per model
