  ...
  const loadSettings = async () => {
    ...
    try {
      ...
      if (settingsRes.ok) {
        ...
        setRequireLogin(data.requireLogin === true);
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 w-full">
            ...
            {tunnelEnabled && !tunnelLoading && tunnelReachable ? (
              <>
                <Input value={`${tunnelPublicUrl || tunnelUrl}/v1`} readOnly className="flex-1 min-w-0 font-mono text-xs sm:text-sm" />
                <button
                  type="button"
                ...
                >
                  <span className="material-symbols-outlined text-[16px] sm:text-[18px]">{copied === "tunnel_url" ? "check" : "content_copy"}</span>
                </button>
                <button
                  type="button"
                  onClick={() => setShowDisableTunnelModal(true)}
                  className="p-1.5 sm:p-2 hover:bg-red-500/10 rounded text-red-500 transition-colors shrink-0 cursor-pointer"
              ...
              <>
                <div className="flex-1 min-w-0 flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded border border-amber-300 dark:border-amber-800 bg-amber-500/5 text-xs sm:text-sm text-amber-600 dark:text-amber-400 truncate">
                  <span className="material-symbols-outlined animate-spin text-xs sm:text-sm shrink-0">progress_activity</span>
              ...
              <>
                <div className="flex-1 min-w-0 flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded border border-border bg-input text-xs sm:text-sm text-text-muted truncate">
                  <span className="material-symbols-outlined animate-spin text-xs sm:text-sm shrink-0">progress_activity</span>
              ...
              <>
                <div className="flex-1 min-w-0 flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded border border-red-300 dark:border-red-800 bg-red-500/5 text-xs sm:text-sm text-red-600 dark:text-red-400 truncate">
                  <span className="material-symbols-outlined text-xs sm:text-sm shrink-0">error</span>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 w-full">
            ...
            {tsEnabled && !tsLoading && tsReachable ? (
              <>
                <Input value={`${tsUrl}/v1`} readOnly className="flex-1 min-w-0 font-mono text-xs sm:text-sm" />
                <button
                  type="button"
                ...
                >
                  <span className="material-symbols-outlined text-[16px] sm:text-[18px]">{copied === "ts_url" ? "check" : "content_copy"}</span>
                </button>
                <button
                  type="button"
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 mt-1 min-w-0">
                    <code className="text-xs text-text-muted font-mono truncate max-w-[140px] xs:max-w-[200px] sm:max-w-md">
          ...
          <div className="bg-surface-2 border border-border-subtle rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Expose your local Dardcor Router to the internet. No port forwarding, no static IP needed. Share endpoint URL with your team or use it in Cursor, Cline, and other AI tools from anywhere.
                </p>
              </div>
            </div>
          </div>
