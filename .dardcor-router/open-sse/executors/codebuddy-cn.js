 ...
 * client sent it, so we force it true here — dardcor-code still re-aggregates the
...
export class CodeBuddyExecutor extends DefaultExecutor {
  ...
  transformRequest(model, body, stream, credentials) {
    ...
    // OpenAI-style params: reasoning_effort + reasoning_summary:"auto". dardcor-code's
