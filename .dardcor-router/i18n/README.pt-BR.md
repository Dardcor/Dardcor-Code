...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           Dardcor Code (Roteador inteligente)            │
...
🎉 O painel abre em `http://localhost:21128`
...
Este pacote de repositório é privado (`dardcor-code-app`), portanto, a execução pelo código-fonte/Docker é o caminho de desenvolvimento local esperado.
...
- Painel: `http://localhost:21128/dashboard`
- API compatível com OpenAI: `http://localhost:21128/v1`
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no Dardcor Code<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Dardcor Code + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
      ...
      <b>🇺🇸 Inglês</b><br/>
      <sub>Dardcor Code + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com Dardcor Code 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Dardcor Code<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida Dardcor Code 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante Dardcor Code no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + Dardcor Code: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
Dardcor Code funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-Dardcor Code-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. Dardcor Code chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → Dardcor Code → Headroom /v1/compress → Dardcor Code → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o Dardcor Code seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → Dardcor Code traduz → Provedor recebe formato nativo
...
> O próprio Dardcor Code **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do Dardcor Code!
...
### 📊 Compreendendo os custos e faturamento do Dardcor Code

**Como funciona o faturamento do Dardcor Code:**

✅ **Software Dardcor Code = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **Dardcor Code nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, Dardcor Code apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **Dardcor Code**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do Dardcor Code.
...
<details>
<summary><b>💳 Serei cobrado pelo Dardcor Code?</b></summary>

**Não.** Dardcor Code é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, Dardcor Code apenas encaminha suas solicitações
- ❌ **Dardcor Code em si** → **Nunca carrega nada, nunca**

Dardcor Code é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O Dardcor Code apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio Dardcor Code. Eles são serviços verdadeiramente gratuitos e o Dardcor Code os torna fáceis de usar com suporte alternativo.
...
- Dardcor Code ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do Dardcor Code evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o Dardcor Code os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. Dardcor Code rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do Dardcor Code]
...
> **Nota:** OpenClaw só funciona com Dardcor Code local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
| `PORT` | padrão da estrutura | Porta de serviço (`21128` nos exemplos) |
...
| `BASE_URL` | `http://localhost:21128` | URL base interna do lado do servidor usada por trabalhos de sincronização na nuvem |
...
- Atualizado automaticamente pelo Dardcor Code
...
- Definir `PORT=21128` e `NEXT_PUBLIC_BASE_URL=http://localhost:21128`
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do Dardcor Code. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O Dardcor Code porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. Dardcor Code adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. Dardcor Code injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do Dardcor Code não existiriam. Dê uma ⭐ a eles no GitHub!
