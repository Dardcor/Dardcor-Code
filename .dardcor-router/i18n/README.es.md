<div align="center">
  <img src="../images/dardcor-code.png?1" alt="Panel de control de Dardcor Code" width="800"/>
  
  # Dardcor Code - Enrutador de IA GRATUITO y ahorrador de tokens
...
[🚀 Inicio rápido](#-inicio-rápido) • [💡 Características](#-características-principales) • [📖 Configuración](#-guía-de-instalación) • [🌐 Sitio web](https://dardcor-code.web.id)
...
🎉 El panel de control se abre en `http://localhost:21128`
...
El paquete de este repositorio es privado (`dardcor-code-app`), por lo que ejecutar desde el código fuente/Docker es la ruta de desarrollo local prevista.
...
- Panel de control: `http://localhost:21128/dashboard`
- API compatible con OpenAI: `http://localhost:21128/v1`
...
<table>
  ...
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với Dardcor Code<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="Dardcor Code + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Dardcor Code + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Dardcor Code + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="Dardcor Code Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Dardcor Code + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with Dardcor Code 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Dardcor Code<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup Dardcor Code 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy Dardcor Code di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy Dardcor Code di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **¿Has hecho un video sobre Dardcor Code?** Envía una [Pull Request](https://github.com/dardcor/dardcor-code/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!

---

## 🛠️ Herramientas CLI compatibles

Dardcor Code funciona a la perfección con todas las principales herramientas de código con IA:
...
Headroom es opcional y se ejecuta por separado. Dardcor Code llama al endpoint local `/v1/compress` de Headroom y luego mantiene el enrutamiento, la reserva, la autenticación y el seguimiento de uso normales:
...
Si Headroom está caído o devuelve un error, Dardcor Code falla de forma segura y envía la solicitud original.
...
- Tu herramienta CLI envía el formato OpenAI → Dardcor Code lo traduce → El proveedor recibe el formato nativo
...
> Dardcor Code por sí mismo **nunca te cobra** nada. Solo pagas a los proveedores directamente (si usas servicios de pago).
>
...
> enrutar a través de Dardcor Code!
...
### 📊 Cómo entender los costes y la facturación de Dardcor Code

**Realidad de la facturación de Dardcor Code:**

✅ **El software de Dardcor Code = GRATUITO para siempre** (código abierto, nunca cobra)  
...
❌ **Dardcor Code nunca envía facturas** ni carga tu tarjeta
...
- **Proveedores económicos** (GLM, MiniMax): Págales directamente, Dardcor Code solo enruta
- **Proveedores GRATUITOS** (iFlow, Kiro, Qwen): Realmente gratuitos para siempre, sin cargos ocultos
- **Dardcor Code**: Nunca cobra nada, jamás
...
El panel realiza el seguimiento de tu uso de tokens y muestra **costes estimados** como si estuvieras usando APIs de pago directamente. Esto **no es facturación real** — es una referencia para mostrar cuánto estás ahorrando al usar modelos gratuitos o suscripciones existentes a través de Dardcor Code.
...
<details>
<summary><b>💳 ¿Dardcor Code me cobrará algo?</b></summary>

**No.** Dardcor Code es un software gratuito y de código abierto que se ejecuta en tu propio ordenador. Nunca te cobra nada.

**Solo pagas:**

- ✅ **Proveedores de suscripción** (Claude Code $20/mes, Codex $20-200/mes) → Págales directamente en sus sitios web
- ✅ **Proveedores económicos** (GLM, MiniMax) → Págales directamente, Dardcor Code solo enruta tus solicitudes
- ❌ **El propio Dardcor Code** → **Nunca cobra nada, jamás**

Dardcor Code es un proxy/enrutador local. No tiene tu tarjeta de crédito, no puede enviar facturas y no tiene sistema de facturación. Es software totalmente gratuito.
...
Dardcor Code solo enruta tus solicitudes hacia ellos — no hay "trampa" ni facturación futura. Son servicios realmente gratuitos y Dardcor Code los hace fáciles de usar con soporte de reserva.
...
3. **Usa los proveedores de suscripción al final:**
   ...
   - Dardcor Code te ayuda a maximizar su valor mediante el seguimiento de cuota
...
La reserva inteligente de Dardcor Code evita cargos sorpresa:
...
**Tú tienes el control:** Establece límites de gasto por proveedor en el panel y Dardcor Code los respeta.
...
**Consejo profesional:** Usa Opus para tareas complejas y Sonnet para velocidad. ¡Dardcor Code realiza el seguimiento de la cuota por modelo!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el panel de dardcor-code]
...
```json
{
  ...
  "anthropic_api_key": "tu-clave-api-de-dardcor-code"
}
```
...
export OPENAI_API_KEY="tu-clave-api-de-dardcor-code"
...
> **Nota:** OpenClaw solo funciona con Dardcor Code local. Usa `127.0.0.1` en lugar de `localhost` para evitar problemas de resolución IPv6.
...
docker pull dardcor/dardcor-code:latest   # actualiza a la última versión
```

**Persistencia de datos:** `$HOME/.dardcor-code/db/data.sqlite` en el host ↔ `/app/data/db/data.sqlite` en el contenedor.

### Variables de entorno

| Variable                                             | Por defecto                                | Descripción                                                                          |
| ---------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------ |
| `JWT_SECRET`                                         | Generado automáticamente (`~/.dardcor-code/jwt-secret`) | Secreto de firma JWT para la cookie de autenticación del panel (sobreescríbelo para compartir entre instancias) |
| `INITIAL_PASSWORD`                                   | `123456`                                   | Contraseña del primer inicio de sesión cuando no existe un hash guardado             |
| `DATA_DIR`                                           | `~/.dardcor-code`                               | Ubicación principal de datos de la app (SQLite en `$DATA_DIR/db/data.sqlite`)        |
| `PORT`                                               | por defecto del framework                  | Puerto del servicio (`21128` en los ejemplos)                                        |
...
| `BASE_URL`                                           | `http://localhost:21128`                   | URL base interna del lado del servidor usada por los trabajos de sincronización en la nube |
| `CLOUD_URL`                                          | `https://dardcor-code.web.id`                      | URL base del endpoint de sincronización en la nube del lado del servidor             |
...
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://dardcor-code.web.id`                      | URL de nube pública/compatible (prefiere `CLOUD_URL` para el runtime del servidor)   |
...
- Tanto `${DATA_DIR}` como `~/.dardcor-code` resuelven a la misma ubicación en un contenedor de Docker — el enlace simbólico `/root/.dardcor-code -> /app/data` se crea en tiempo de compilación.
...
- Dardcor Code lo renueva automáticamente
...
- Establece `PORT=21128` y `NEXT_PUBLIC_BASE_URL=http://localhost:21128`
...
- **Problemas**: [github.com/dardcor/dardcor-code/issues](https://github.com/dardcor/dardcor-code/issues)

---

## 👥 Colaboradores

¡Gracias a todos los colaboradores que ayudaron a mejorar Dardcor Code!
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Un fork de Dardcor Code en TypeScript con todas las funciones. Añade más de 36 proveedores, reserva automática de 4 niveles, APIs multimodales (imágenes, embeddings, audio, TTS), interruptor de circuitos, caché semántica, evaluaciones de LLM y un panel pulido. Más de 368 pruebas unitarias. Disponible a través de npm y Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — ahorrador de tokens en Rust. Dardcor Code porta su pipeline de compresión a JS → **−20-40% de tokens de entrada** en cada solicitud.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. Dardcor Code adapta su prompt → **−65% de tokens de salida**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — habilidad del _"dev sénior perezoso"_. Dardcor Code inyecta su jerarquía primero-YAGNI → **menos tokens, menos código, diffs más cortos**.

Un enorme agradecimiento a estos autores — sin su trabajo, las funciones de ahorro de tokens de Dardcor Code no existirían. ¡Dales una ⭐ en GitHub!
