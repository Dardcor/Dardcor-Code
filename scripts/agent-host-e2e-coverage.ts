...
function main(): void {
	...
	run(process.execPath, [
		...
		'--include', 'out/dc/platform/agentHost/common/**/*.js',
		'--include', 'out/dc/platform/agentHost/node/**/*.js',
		'--exclude', 'out/dc/platform/agentHost/**/test/**',
		'--exclude', 'out/dc/platform/agentHost/**/*.test.js',
		'--exclude', 'out/dc/platform/agentHost/**/*.integrationTest.js',
		'--exclude', 'out/dc/platform/agentHost/common/state/protocol/channels-*/{actions,commands,notifications,state}.js',
		'--exclude', 'out/dc/platform/agentHost/common/state/protocol/common/state.js',
	], environment);
...
function writeStats(): void {
	...
	const stats = {
		...
		scope: {
			...
			include: [
				'src/dc/platform/agentHost/common/**/*.ts',
...
function toSourcePath(filePath: string): string {
	...
	if (!/^src\/dc\/platform\/agentHost\/(?:common|node)\/.+\.ts$/.test(repoRelativePath) || repoRelativePath.includes('/test/')) {
...
function writeProtocolSurfaceStats(): void {
	...
	const stats = {
		version: 1,
		scope: {
			source: 'src/dc/platform/agentHost/common/state/protocol',
