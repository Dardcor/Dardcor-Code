...
if [ -f ./src/dccode-dts/vscode.d.ts ]; then
	echo "$header" > index.d.ts
	sed "1,4d" ./src/dccode-dts/vscode.d.ts >> index.d.ts
	echo "Generated index.d.ts for version ${1}."
else
	echo "Can't find ./src/dccode-dts/vscode.d.ts. Run this script at vscode root."
fi
